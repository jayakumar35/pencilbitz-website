     ...
     Adhoc And Sencor Networks
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/adhoc-and-sensor-networks-1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/adhoc-and-sensor-networks-2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/adhoc-and -sensor-networks-3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          ...
          <div class="mb-3">
            ...
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">R. Dinesh Kumar <br> Dr.P.Chinniah</li>
        ...
        <div class="mt-3 border-t pt-2">
            ...
            <li>No need for routers or access points. Devices connect directly.</li>
            <li>Network structure changes as nodes move or join/leave.</li>
            <li>Nodes can automatically join and configure themselves.</li>
            <li>Data can be forwarded through intermediate nodes.</li>
            <li class="hidden" id="more-features">
             No central server; all nodes have equal roles.<br>
              Ideal for emergency or temporary setups (e.g., disaster recovery, military).<br>
              Usually battery-operated with range limitations.<br>
             Usually battery-operated with range limitations.<br>
              Requires special protocols like AODV, DSR for routing.
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="adhoc-and-sencor-networks-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
