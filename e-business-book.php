...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>E-Business | Pencil Bitz Book </title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="e-business-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/e-business-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-neutral-500');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-neutral-500');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/e-business-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/e-business-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-neutral-500 mb-2">E-Business</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class=""> Dr.Prashantha Kumar O <br> Mrs.Chaitra S <br> Mr.Narendrakumar B  <br> Mrs.Chaithrakala R</li>
                            <li>
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>E-business refers to conducting business processes on the internet, including buying, selling, servicing, and collaboration.</li>
                            <li>It is broader than e-commerce, covering not only online transactions but also supply chain management, customer relationship management, and internal operations.</li>
                            <li>Companies use e-business to reduce costs and improve efficiency by automating tasks.</li>
                            <li>It enables global reach, allowing businesses to connect with customers worldwide.</li>
                            <li class="hidden" id="more-features">
                              Online platforms, websites, and mobile apps are the primary tools of e-business.<br>
                              Digital marketing plays a crucial role in attracting and retaining customers.<br>
                              E-business supports both B2B (business-to-business) and B2C (business-to-customer) models.<br>
                              Security, data protection, and trust are major challenges in e-business.
                            </li>
                        </ul>
                    ...
                    <a href="e-business-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-neutral-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 174</li>
