...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="operation-research-book.php" class="hover:underline text-blue-600 flex items-center">
     ...
     Operation Research
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/operation-research-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/operation-research-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/operation-research-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-emerald-500 mb-2"> Operation Research</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr.M.Parimaladevi <br> Dr.T.Vanthana</li>
              <li>
                <br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-77-6| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Scientific Decision-Making – Uses mathematical and analytical methods to support better decision-making in complex systems.</li>
                <li>Optimization Techniques – Focuses on maximizing efficiency or minimizing costs through models like linear programming and dynamic programming.</li>
                <li>Quantitative Analysis – Employs data, statistics, and models to evaluate alternative strategies objectively.</li>
                <li>Simulation and Modeling – Uses computer-based models to analyze real-world operations and predict outcomes.</li>
                <li class="hidden" id="more-features">
              Resource Allocation – Helps in optimal utilization of limited resources such as manpower, materials, and machinery.<br>
               Decision Theory – Provides structured approaches for decision-making under certainty, risk, and uncertainty.<br>
               Applications in Business and Industry – Widely used in logistics, production planning, scheduling, transportation, and supply chain management.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="operation-research-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-emerald-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>120</li>
            <li><span class="font-semibold">Dimensions:</span> 24 x 18 x 1.5 cm</li>
            <li><span class="font-semibold">Weight:</span> 210g</li>
          </ul>
        </div>
