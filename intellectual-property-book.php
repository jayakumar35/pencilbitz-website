...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/intellectual-property-1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/intellectual-property-2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/intellectual-property-3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">Intellectual Property Rights</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> Dr.Jemimah Winston
                                <br>Dr.Mobi Rajendran
                                <br> Dr. Jenifer Thangam J.
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-992599-5-9| 2025 |</span></div>
                            </li>
                        </ul>
          ...
          class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Dr. David Raj - JPG</a> -->
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        ...
                        <span class="text-base text-gray-500 line-through ml-2">₹1238/-</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="/intellectual-property-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2">
                        <span class="font-medium text-gray-800">Intellectual property rights protect creative works, inventions, and brand identifiers by giving creators exclusive legal control over their use and distribution. These rights—such as copyrights, patents, trademarks, and trade secrets—encourage innovation and cultural development by enabling creators to benefit economically from their efforts. Copyrights cover original literary, musical, and artistic works, while patents protect novel inventions and technical solutions for a limited period. Trademarks safeguard brand names, logos, and slogans that distinguish goods and services in the marketplace, and trade secrets preserve confidential business information that provides a competitive edge. Balancing protection with public access is essential, so laws include limitations and exceptions like fair use to promote education, research, and follow-on innovation. Effective IP regimes thus foster creativity, investment, and informed consumer choice while requiring careful enforcement and policy to prevent misuse or overreach.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>258</li>
