...
<head>
  ...
  <script>
    function sendWhatsAppOrder() {
      const bookName = document.getElementById("book-name").innerText;
      const name = document.getElementById("name").value;
      const address = document.getElementById("address").value;
      const contact = document.getElementById("contact").value;
      const quantity = document.getElementById("quantity").value;

      if (!name || !address || !contact || !quantity) {
        alert("Please fill in all fields.");
        return;
      }

      const message = `Book Order Details:%0A--------------------%0ABook Name : ${bookName}%0AName : ${name}%0AAddress : ${address}%0AContact Number : ${contact}%0AQuantity : ${quantity}`;
      const whatsappUrl = `https://wa.me/919944307413?text=${message}`;
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
      ...
      <li class="flex items-center">
        <a href="book-store.php#cloud-computing" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/cloud computer-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-purple-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-purple-800');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/cloud computer-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-purple-900 mb-2">Cloud Computing</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            ...
            <li>Comprehensive coverage of cloud fundamentals</li>
            <li>Real-world case studies and practical examples</li>
            <li>Explains deployment and service models (IaaS, PaaS, SaaS)</li>
            <li>Focus on security, privacy, and compliance in the cloud</li>
            <li>Includes hands-on exercises and review questions</li>
            <li class="hidden" id="more-features">
              Covers cloud migration strategies<br>
              Discusses emerging trends and technologies<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="cloud-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-purple-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-purple-700">
