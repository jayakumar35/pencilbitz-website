...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Fundamentals of Cyber Security | Pencil Bitz Books </title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="Fundamentals-of-Cyber-Security-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/Fundamentals-of-Cyber-Security-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/Fundamentals-of-Cyber-Security-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/Fundamentals-of-Cyber-Security-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">Fundamentals of Cyber Security </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="">Mrs.A.Subha Priyadharshini
                                <br>Dr. Sam Abraham
                                <br>Mr.P.John William
                                <br>Mr.Anik Acharjee
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-42-8| 2025</span></div>
                            </li>
                        </ul>
               ...
               <!-- Flipkart -->
              <a href="https://www.flipkart.com/fundamentals-cyber-security-1-disc/p/itm14c87f6eb7179?pid=9789389911428" target="_blank"
              ...
              <!-- <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                            ...
                            <div id="certificatePopup"
                                ...
                                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        <p class="text-sm text-gray-600 mb-2">Download your certificate:</p>Mrs.A.Subha Priyadharshini
                                <br>
                                <br>Mr.P.John William
                                <br>
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Fundamentals of Cyber Security a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mrs.A.Subha Priyadharshini- PDF</a>
                                        </div>

                                        <!-- Author 2 -->
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Fundamentals of Cyber Security a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr. Sam Abraham- PDF</a>
                                        </div>

                                        <!-- Author 3 -->
                                        <div id="author3" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Fundamentals of Cyber Security a3.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mr.P.John William- PDF</a>
                                        </div>

                                        <!-- Author 4 -->
                                        <div id="author4" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Fundamentals of Cyber Security a4.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mr.Anik Acharjee- PDF</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="Fundamentals-of-Cyber-Security-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800">Cyber security focuses on protecting digital systems, networks, and data from unauthorized access and malicious threats. It combines technical safeguards, policies, and best practices to ensure confidentiality, integrity, and availability. As cyber risks grow, individuals and organizations must strengthen defenses and awareness. Understanding these fundamentals is essential for building a secure and resilient digital environment.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 264</li>
