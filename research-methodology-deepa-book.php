...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="research-methodology-deepa-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/research-methodology-deepa-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/research-methodology-deepa-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/research-methodology-deepa-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-yellow-700 mb-2">Research Methodology</h2>
                    <div class="mb-3">
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Research methodology is the systematic process used to collect, analyze, and interpret data.</li>
                            <li>It provides structured guidelines for conducting research effectively and scientifically.</li>
                            <li>The methodology includes choosing appropriate research design (qualitative, quantitative, or mixed).</li>
                            <li>It defines the tools and techniques used for data collection, such as surveys, interviews, or experiments.</li>
                            <li class="hidden" id="more-features">
                             Sampling methods are applied to select participants or data sources.<br>
                             Data analysis techniques help in interpreting results to draw meaningful conclusions.<br>
                             Reliability and validity ensure the accuracy and consistency of research findings.<br>
                             Ethical considerations are vital to maintain integrity, honesty, and fairness in research.<br>
                             A clear methodology enhances credibility and replicability of the study.
                             Overall, research methodology serves as the foundation for producing valid and reliable knowledge.
                            </li>
                        </ul>
                    ...
                    <a href="research-methodology-deepa-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-700 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 244</li>
