...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title> Engineering Chemistry | Pencil Bitz Book</title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="business-analytics-sharathchandra-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/engeering-chemistry-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/engeering-chemistry-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/engeering-chemistry-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-orange-600 mb-2">Engineering Chemistry</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class=""> Dr.V.USHA  <br> Isha Das  <br> Dr.Renu S Nair  <br> Dr.Meena Devi</li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-41-7| 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Engineering Chemistry deals with the application of chemical principles to engineering and technology</li>
                            <li>It studies the structure, properties, and reactions of materials used in industries.</li>
                            <li>Topics include water chemistry, polymers, fuels, corrosion, alloys, and nanomaterials.</li>
                            <li class="hidden" id="more-features">
                              Water treatment (softening, desalination, purification) is essential for industrial and domestic use.<br>
                               Polymers and composites are important for making lightweight, durable materials.<br>
                               Predictive models use machine learning and statistical techniques to forecast trends.<br>
                                Fuels (solid, liquid, gaseous) and their calorific values are vital for energy generation.<br>
                             Corrosion science helps in preventing material degradation in structures and machines.
                            </li>
                        </ul>
                    ...
                    <a href="engineering-chemistry-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="https://www.instagram.com/pencilbitz" target="_blank" class="text-orange-600 text-2xl" title="Instagram"><i class="fab fa-instagram"></i></a>
