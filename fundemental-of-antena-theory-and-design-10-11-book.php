    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        ...
        "
                ...
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">DR. S. PARAMESWARI
                                <br>DR. C. CHITRA
          ...
          class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Dr. David Raj - JPG</a> -->
                    ...
                    <a href="/fundemental-of-antena-theory-and-design-10-11-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
