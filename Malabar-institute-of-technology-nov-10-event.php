                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mb-6 lg:mb-0">
                        <div class="d-flex justify-content-center align-items-center h-auto">
                            <img src="assets/img/upcomeing-event/Malabar-institute-of-technology-nov-10.jpg" alt="Event Image" class="w-full max-h-[700px] object-cover rounded-xl shadow-xl transition-transform duration-500 hover:scale-[1.01]">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="event-content px-2">
                            ...
                            <h2 class="text-2xl font-semibold text-red-600 mb-6 pl-3">AI Tools For Academic Content Creation</h2>
                            ...
                            <ul class="space-y-4 mb-8 text-gray-700 font-medium">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Date:</strong> 10 November 2025
                                    </div>
                                </li>
                                <li class="flex items-start">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Location:</strong> Anjarakandy, Kerala
                                    </div>
                                </li>
                                <li class="flex items-start">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="https://forms.gle/giWdebMoenpkPRsT7" class="register-button inline-flex items-center justify-center bg-red-600 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300 transform hover:scale-[1.02]">
