...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="postcolonial-narratives-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/postcolonial-narratives-in-world-literature-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-amber-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-amber-800');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/probleem-solving-with-python-programming-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/postcolonial-narratives-in-world-literature-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        <img
          id="main-book-img"
          src="assets/img/new/book-page/postcolonial-narratives-in-world-literature-p3.png"
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-amber-800 mb-2">  Postcolonial Narratives in the World Literature</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr. A. Priya, Dr. J. Charles Arockiasamy</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-85-1| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Representation of Colonial Experiences – Explores the impact of colonization on culture, identity, and society through the voices of formerly colonized peoples.</li>
                <li>Decolonization of Mind and Language – Challenges Eurocentric perspectives by reclaiming indigenous languages, traditions, and storytelling methods.</li>
                <li>Hybrid Identities – Highlights the blending of cultures and identities resulting from colonial encounters, often showing characters caught between two worlds.</li>
                <li>Resistance and Empowerment – Focuses on struggles for freedom, justice, and cultural survival against colonial domination and its lingering effects.</li>
                <li class="hidden" id="more-features">
                 Critique of Imperialism – Questions the political, economic, and cultural control exerted by colonial powers, both historically and in modern forms.br>
                 Voice to the Marginalized – Amplifies the experiences of oppressed groups—indigenous peoples, women, and minorities—long silenced in traditional literature.<br>
                  Includes numerous coding exercises, quizzes, and mini projects for self-assessment.<br>
                 Voice to the Marginalized – Amplifies the experiences of oppressed groups—indigenous peoples, women, and minorities—long silenced in traditional literature.<br>
                Themes of Migration and Diaspora – Examines displacement, exile, and the search for identity in a globalized postcolonial world.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1226</span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹1126</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="postcolonial-narratives-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-amber-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>260</li>
