    ...
    <div class="row mx-auto">
        <nav class="mb-6 rounded-lg px-4 py-3">
            <ol class="flex items-center text-gray-700 space-x-2 text-sm font-medium">
                ...
                <li class="flex items-center">
                    <a href="intellectual-property-rights-book.php" class="hover:underline text-blue-600 flex items-center">
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div style="background-image: none;" class="container max-w-lg">
            <div class="bg-white shadow-xl rounded-lg p-8 flex flex-col items-center">
                <img src="assets/img/new/book-page/intellectual-property-3.png" class="w-100 h-auto rounded border-0 shadow-md mb-4" alt="Cloud Computing Book">
                <h2 id="book-name" class="text-2xl font-bold mt-2 mb-4 text-center">Intellectual Property Rights</h2>
