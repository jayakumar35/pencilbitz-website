...
<body class="bg-gray-50 font-sans min-h-screen flex items-center justify-center p-4 sm:p-6">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-soft overflow-hidden border border-gray-100">
        ...
        <div class="bg-green-100 py-4 px-6 border-b border-gray-200 flex flex-col items-center">
            ...
            <p class="text-gray-600 text-sm sm:text-base mt-1">Patent Grant Support</p>
        </div>
        ...
        <div class="qr-container p-6 sm:p-8 flex flex-col items-center">
            ...
            <div class="text-center w-full">
                <h1 class="text-gray-800 text-xl font-semibold mb-3 tracking-tight">PON SRIDHARAN KUMARA</h1>
                <div class="flex upi-container items-center justify-center">
                    <div class="bg-white bg-opacity-20 rounded-lg px-4 py-2 upi-id">
                        <p id="upi-id" class="text-gray-800 font-medium text-sm sm:text-base truncate max-w-xs"> pencilbitz@okicici</p>
                    </div>
        ...
        <div class="mx-6 my-4 bg-pencilbitz-light rounded-xl p-3 border border-gray-200 shadow-inner">
            ...
            <div class="space-y-3">
                <!-- Phone -->
               <ul >
                <li class="font-medium text-md text-gray-800" ><strong>Account Holder:</strong><span> PON SRIDHARAN KUMARA </span></li>
                <li class="font-medium text-md text-gray-800" ><strong>Account Number:</strong><span> 1166155000229773 </span></li>
                <li class="font-medium text-md text-gray-800" ><strong>Account IFSC:</strong><span>  KVBL0001166  </span></li>
                <li class="font-medium text-md text-gray-800" ><strong>Account Branch:</strong> <span> MUSIRI </span></li>
