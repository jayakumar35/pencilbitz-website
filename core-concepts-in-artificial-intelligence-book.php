    ...
    <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
      <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
        <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
          ...
          <li class="flex items-center">
            <a href="core-concepts-in-artificial-intelligence-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
            src="assets/img/new/book-page/core-concepts-inartificial-intelligence-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-fuchsia-900');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-fuchsia-900');
          this.classList.add('border-gray-600');
        "
            alt="Thumbnail 1">
          <img
            src="assets/img/new/book-page/core-concepts-inartificial-intelligence-p2.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            alt="Thumbnail 2">
          <img
            src="assets/img/new/book-page/core-concepts-inartificial-intelligence-p3.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-fuchsia-900 mb-2">Core Concepts in Artificial Intelligence </h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li class="uppercase">Dr.T.Kamaleshwar | L Sowjanya Upadhyayula | Dr.M.Kavitha | Dr. Sapna Singh</li>
              <li>
                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-992230-8-0| 2025 |</span></div>
              </li>
            </ul>
                ...
                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                  ...
                  <div id="downloadSection" class="mt-5 hidden">
                    ...
                    <div id="author1" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Core Concepts in Artificial Intelligence a1.pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.T.Kamaleshwar - PDF</a>
                    </div>

                    <!-- Author 2 -->
                    <div id="author2" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Core Concepts in Artificial Intelligence a2.pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> L Sowjanya Upadhyayula - PDF</a>
                    </div>

                    <!-- Author 3 -->
                    <div id="author3" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Core Concepts in Artificial Intelligence a3.pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.M.Kavitha - PDF</a>
                    </div>

                    <!-- Author 4 -->
                    <div id="author4" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Core Concepts in Artificial Intelligence a4.pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr. Sapna Singh - PDF</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <a href="core-concepts-in-artificial-intelligence-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-fuchsia-900 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <p class="text-gray-700 leading-relaxed p-2">
            <span class="font-medium text-gray-800">Artificial Intelligence (AI) focuses on developing machines that can perform tasks requiring human-like intelligence. Key concepts include machine learning, where systems learn from data; deep learning, which uses neural networks for pattern recognition; and natural language processing, enabling computers to understand and communicate in human language. Computer vision allows interpretation of images and videos, while expert systems and reinforcement learning enable decision-making and adaptive learning. AI also emphasizes ethics, ensuring fairness and transparency. These core concepts power real-world applications in healthcare, finance, robotics, and education, revolutionizing industries and shaping the future of intelligent technologies.
          </p>
        </div>
        ...
        <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
          <div class="flex gap-4 ps-5">
            ...
            <a href="mailto:info@pencilbitz.com" class="text-fuchsia-900 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
