    ...
    <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
            src="assets/img/new/book-page/artificial-intelligence-in-modern-approach-p1.png"
        ...
        "
            alt="Thumbnail 1">
          <img
            src="assets/img/new/book-page/artificial-intelligence-in-modern-approach-p2.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            alt="Thumbnail 2">
          <img
            src="assets/img/new/book-page/artificial-intelligence-in-modern-approach-p3.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-500 mb-2">Artificial Intelligence in Modern Approach </h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li class="uppercase">Dr Jothimani Ponnusamy <br> Biju Thomas <br> P.Sakthiprakash <br> Ashok Kumar Manda" </li>
              <li>
                <br>
                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-992230-9-7| 2025 |</span></div>
              </li>
            </ul>
          ...
          <a href="artificial-intelligence-in-modern-approach-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <p class="text-gray-700 leading-relaxed p-2">
            <span class="font-medium text-gray-800">Artificial Intelligence in Modern Approach provides a comprehensive overview of AI concepts, techniques, and applications. It covers machine learning, neural networks, natural language processing, and robotics, emphasizing problem-solving and intelligent decision-making. The book bridges theory with real-world examples, showcasing how AI transforms modern industries.
          </p>
        </div>
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>206</li>
