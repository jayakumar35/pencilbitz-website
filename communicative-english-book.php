...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title>Communicative English | Pencil Bitz Book</title>
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="communicative-english-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/communicative-english-p1.png"
        ...
        onclick="
          ...
          this.classList.remove('border-emerald-');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/communicative-english-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/communicative-english-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-emerald- mb-2"> Communicative English </h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Mrs. Swetha Balaji | Dr. Manoj Kumar Katual | Mrs. Saswati Jena | Dr. S.Reno </li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-56-1| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Communicative English focuses on using the English language effectively in real-life situations.</li>
                <li>It emphasizes practical communication over memorization of grammar rules.</li>
                <li>Listening, speaking, reading, and writing are the four key skills developed.</li>
                <li>Activities like group discussions, role-plays, and presentations build fluency and confidence.</li>
                <li class="hidden" id="more-features">
                   Vocabulary and pronunciation are improved for clear and accurate expression.<br>
                    It encourages interactive learning rather than passive knowledge acquisition.<br>
                    Non-verbal communication, such as body language and tone, also plays a vital role.<br>
                    It helps in academic, professional, and social interactions.<br>
                   Globalization has made Communicative English a key tool for career growth.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="communicative-english-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-emerald- font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
