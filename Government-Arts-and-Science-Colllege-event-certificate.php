                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mb-6 lg:mb-0">
                        <div class="d-flex justify-content-center align-items-center h-auto">
                            <img src="assets/img/upcomeing-event/Government-Arts-and-Science-Colllege-28-10.jpg" alt="Event Image" class="w-full max-h-[700px] object-cover rounded-xl shadow-xl transition-transform duration-500 hover:scale-[1.01]">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="event-content px-2">
                            ...
                            <h1 class="font-extrabold text-4xl text-gray-800 leading-tight mb-4 border-l-4 border-red-500 pl-3">
                                GOVERNMENT ARTS AND SCIENCE COLLEGE
                            </h1>
                            <h3 class="text-lg font-bold text-gray-500 tracking-wider uppercase mb-1">Titel</h3>
                            <h2 class="text-2xl font-semibold text-red-600 mb-6 pl-3">AI Tools For Effective Teaching</h2>
                            ...
                            <ul class="space-y-4 mb-8 text-gray-700 font-medium">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Date:</strong> 03 November 2025
                                    </div>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-clock text-sky-500 text-xl w-6 mt-1 mr-3 flex-shrink-0"></i>
                                    <div>
                                        <strong class="text-gray-800">Time:</strong> 7:00PM To 8:00PM
                                    </div>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-map-marker-alt text-sky-500 text-xl w-6 mt-1 mr-3 flex-shrink-0"></i>
                                    <div>
                                        <strong class="text-gray-800">Location:</strong>Thiruvennainallur, Tamil Nadu
                                    </div>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-user-tie text-sky-500 text-xl w-6 mt-1 mr-3 flex-shrink-0"></i>
                                    <div>
                                        <strong class="text-gray-800">Speaker Contact:</strong> <a href="tel:+917708828673" class="text-blue-600 hover:text-blue-500 underline">+91 77088 28673</a>
                                    </div>
                                </li>
                            </ul>

                            <div class="flex flex-wrap gap-4">
                                <a href="#event" class="register-button inline-flex items-center justify-center bg-red-600 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300 transform hover:scale-[1.02]">
                                    Register Now <i class="fas fa-arrow-right ml-2"></i>
                                </a>
                                <a href="assets/img/event-certificate/government_certificates.pdf" class="register-button inline-flex items-center justify-center bg-sky-500 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-sky-600 transition-colors duration-300" download="">
