...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/Corporate-Accounting-monu-book.php" class="hover:underline text-blue-600 flex items-center">
                            <i class="fa-solid fa-book-open-reader mr-2 text-bule"></i>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/Corporate-Accounting-monu-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/Corporate-Accounting-monu-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/Corporate-Accounting-monu-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="list-disc list-inside text-gray-700">
                            <li class=""> Dr. Monu Rathore <br>
                                Ms. Pooja Jhala
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-99-2| 2025</span></div>
                            </li>
                        </ul>
              ...
              <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Dr. Monu Rathore- PDF</a>
                                        </div>
                                        ...
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Ms. Pooja Jhala- PDF</a>
                                        </div>
                    ...
                    <a href="/Corporate-Accounting-monu-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800">Corporate Accounting involves the systematic recording, analysis, and reporting of financial transactions of companies. It focuses on preparing financial statements, managing share capital, handling mergers and acquisitions, valuing assets and liabilities, and ensuring compliance with accounting standards and regulations. It supports informed decision-making by providing accurate insights into profitability, financial stability, and performance. Corporate accounting also includes auditing, consolidation of accounts, and interpretation for stakeholders such as investors and management.
                    </p>
                </div>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4 ps-5">
                        ...
                        <a href="tel:+917200741307" class="text-blue-600 text-2xl" title="Call"><i class="fas fa-phone"></i></a>
                    </div>
