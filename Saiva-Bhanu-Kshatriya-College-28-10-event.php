    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0 text-center">
                <img src="assets/img/upcomeing-event/Saiva-Bhanu-Kshatriya-College1-28-10.jpg" 
            ...
            <div class="col-lg-6 col-md-12">
                <div class="event-content px-2 position-relative">
                    ...
                    <h1 class="text-gray-700 fw-semibold mb-3"> SAIVA BHANU KSHATRIYA COLLEGE</h1>

                    <h3 class="text-gray-500">Topic</h3>
                    <h1 class="text-red-500 fw-semibold mb-3">AI For Sustainable Development Goals</h1>

                    <h3 class="text-gray-500">Details</h3>
                    <ul class="list-unstyled mb-4">
                        <li class="mb-2"><i class="fas fa-calendar-alt me-2 text-primary"></i> <strong>Date:</strong> 20 December 2025</li>
                        <li class="mb-2"><i class="fas fa-clock me-2 text-primary"></i> <strong>Time:</strong> 6:00PM To 8:00PM</li>
                        <li class="mb-2"><i class="fas fa-map-marker-alt me-2 text-primary"></i> <strong>Location:</strong> Aruppukkottai, Tamil Nadu</li>
                        <li class="mb-2"><i class="fas fa-user-tie me-2 text-primary"></i> <strong>Speaker:</strong> +91 77088 28673</li>
                    </ul>

                    <!-- Buttons -->
                    <div class="d-flex justify-content-between flex-wrap gap-3">
                        <a  class="btn text-gray-800 font-semibold py-2 px-4 rounded shadow d-inline-flex align-items-center gap-2" href="https://forms.gle/rA1mXN9wKM2zPpGf9" 
