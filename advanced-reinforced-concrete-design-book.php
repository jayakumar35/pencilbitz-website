...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="advanced-reinforced-concrete-design-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/advanced-reinforcen-concrete-design-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/advanced-reinforcen-concrete-design-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/advanced-reinforcen-concrete-design-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-400 mb-2"> Advanced reinforced concrete design</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Design of Structural Elements – Focuses on advanced design of beams, slabs, columns, and footings under complex loading conditions.</li>
                <li>Limit State and Ultimate Strength Methods – Applies modern design philosophies for safety and serviceability.</li>
                <li>Design of Special Structures – Covers water tanks, retaining walls, silos, domes, and bridges using reinforced concrete.</li>
                <li>Earthquake-Resistant Design – Emphasizes ductility, seismic detailing, and structural performance under dynamic loads.</li>
                <li class="hidden" id="more-features">
          Prestressed and Composite Concrete Design – Integrates prestressing concepts and composite member design for strength and efficiency.  <br>
             Use of Design Codes – Refers to IS 456, IS 1343, and other relevant standards for design and detailing.<br>
              Durability and Sustainability – Addresses corrosion prevention, material optimization, and long-term structural performance.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="advanced-reinforced-concrete-design-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
