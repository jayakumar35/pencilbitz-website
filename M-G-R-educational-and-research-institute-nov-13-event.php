                    ...
                    <div class="event-content px-2">
                        <div class="mb-2">
                            ...
                            <h1 class="font-semibold text-gray-700 text-3xl py-2 ps-3">
                                M.G.R. EDUCATIONAL AND RESEARCH INSTITUTE DEEMED TO BE UNIVERSITY</span>
                            </h1>
                        </div>
                        <h3 class="fw-medium fs-3 text-gray-500  ">Topic</h3>
                        <h1 class="fw-semibold fs-2 text-red-500 mb-3 ps-3">Recent Advances In Biomedical Instrumentation</h1>
                        ...
                        <ul class="list-unstyled mb-4 ps-3 ">
                            ...
                            <li class="mb-2"><i class="fas fa-clock text-primary me-2"></i> <strong>Time:</strong> 10:00AM To 1:00PM </li>
                        ...
                        <a href="https://forms.gle/UBktvhxS5hpNQYBw8" class="bg-gray-200 hover:bg-green-300 hover:text-gray-800 rounded-2 text-gray-800 shadow-lg fw-bold px-4 py-2">
