...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="hr-analytics-data-driven-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/hr-analytics-data-driven-decision-making-in-human-resources-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/hr-analytics-data-driven-decision-making-in-human-resources-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/hr-analytics-data-driven-decision-making-in-human-resources-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-emerald-500 mb-2"> HR Analytics - Data Driven Decision Making in Human Resources</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Data-Centric HR Practices – Focuses on using data and metrics to improve workforce planning, recruitment, and performance management.</li>
                <li>Predictive Analytics – Applies statistical models and machine learning to forecast employee turnover, engagement, and productivity.</li>
                <li>Evidence-Based Decision Making – Encourages HR decisions backed by data insights rather than intuition.</li>
                <li>Performance Measurement – Uses KPIs and dashboards to evaluate employee and organizational effectiveness.</li>
                <li class="hidden" id="more-features">
               Talent Management Optimization – Identifies high performers, skill gaps, and succession planning opportunities.<br>
                HR Technology Integration – Employs HRIS, AI, and analytics tools for real-time data tracking and reporting.<br>
                 Strategic Business Alignment – Connects HR outcomes with organizational goals to enhance overall business performance.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="hr-analytics-data-driven-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-emerald-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
