    ...
    <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
            src="assets/img/new/book-page/Principles of Management1-p1.png"
        ...
        "
            alt="Thumbnail 1">
          <img
            src="assets/img/new/book-page/principles-of-management1-p2.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            alt="Thumbnail 2">
          <img
            src="assets/img/new/book-page/principles-of-management1-p3.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">Principles of Management</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li class="uppercase">Mr.M.Saravanan | Mr.S.Rajkamal</li>
              <li>
                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-993118-8-6| 2025 |</span></div>
              </li>
            </ul>
                ...
                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                  ...
                  <div id="downloadSection" class="mt-5 hidden">
                    ...
                    <div id="author1" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Principles of Management a1 (1).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mr.M.Saravanan - PDF</a>
                    </div>

                    <!-- Author 2 -->
                    <div id="author2" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Principles of Management a2 (1).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mr.S.Rajkamal - PDF</a>
                    </div>
          ...
          <a href="principles-of-management1-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <p class="text-gray-700 leading-relaxed p-2">
            <span class="font-medium text-gray-800">Principles of management provide a framework for planning, organizing, leading, and controlling organizational activities to achieve goals efficiently and effectively. They guide decision-making, coordination, and the alignment of resources with strategy, while adapting to changing environments and stakeholder needs.
          </p>
        </div>
