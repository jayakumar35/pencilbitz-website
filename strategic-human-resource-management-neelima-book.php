...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="strategic-human-resource-management-bini-marni-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/strategic-hunan-resource-management-neelima-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/strategic-hunan-resource-management-neelima-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/strategic-hunan-resource-management-neelima-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-orange-400 mb-2">Strategic Human Resource Management</h2>
                    <div class="mb-3">
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Alignment with Organizational Goals – Integrates HR strategies with overall business objectives for sustainable growth.</li>
                            <li>Workforce Planning and Talent Management – Focuses on attracting, developing, and retaining skilled employees to meet strategic needs.</li>
                            <li>Performance Management Systems – Implements metrics, appraisals, and reward systems aligned with organizational strategy.</li>
                            <li>Employee Engagement and Culture – Promotes a positive work environment to enhance motivation and productivity.</li>
                            <li class="hidden" id="more-features">
                               Change Management – Supports organizational transformation and adaptability in dynamic business environments. <br>
                               HR Analytics and Decision Making – Uses data-driven insights for strategic workforce decisions.<br>
                               Global and Ethical Considerations – Addresses diversity, inclusion, and ethical HR practices in international contexts.<br>
                            </li>
                        </ul>
                        </ul>
                    ...
                    <a href="strategic-human-resource-management-neelima-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
