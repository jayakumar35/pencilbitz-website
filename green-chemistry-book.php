...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3">
      <ol class="flex flex-wrap items-center text-gray-700 space-x-1 text-sm font-medium">
      <li class="flex items-center">
        <a href="index.php" class="hover:underline text-blue-600 flex items-center">
        <i class="fas fa-home mr-1"></i> Home
        </a>
        <span class="mx-1 text-gray-400"><i class="fas fa-chevron-right"></i></span>
      </li>
      <li class="flex items-center">
      ...
      <li class="flex items-center flex-wrap">
        <a href="Green-chemistry-sustainable-methods-and-Innovations-book.php" class="hover:underline text-blue-600 flex items-center">
        <i class="fas fa-leaf mr-1"></i>
        <i class="fas fa-flask mr-1"></i>
        <span class="sm:inline block">Green Chemistry Sustainable Methods and Innovations</span>
        </a>
      </li>
      </ol>
    </nav>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Green chemistry sustainable methods and Innovations-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Green chemistry sustainable methods and Innovations-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/Green chemistry sustainable methods and Innovations-p3.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          ...
          <img
        src="assets/img/new/book-page/Green chemistry sustainable methods and Innovations-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2  sm:text-base">Green chemistry sustainable methods and Innovations</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr. P. Sumathi <br> V. Geetha <br> Dr. S. Prasad</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-82-0| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Explores the principles and practices of green chemistry for sustainable development.</li>
                <li>Highlights innovative methods for eco-friendly chemical synthesis and processes.</li>
                <li>Discusses the reduction of hazardous substances and waste minimization strategies.</li>
                <li>Includes case studies on industrial applications and real-world green innovations.</li>
                <li class="hidden" id="more-features">
                    Covers renewable resources, catalysis, and alternative solvents.<br>
                    Focuses on environmental impact assessment and regulatory aspects.<br>
                    Suitable for students, researchers, and professionals in chemistry and environmental science.<br>
                    Features review questions and practical exercises for deeper understanding.<br>
                    Authored by experienced educators and industry experts.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="green-chemistry-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-sky-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
        ...
        <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
          <div class="flex gap-4 ps-5">
            ...
            <a href="https://www.facebook.com/pencilbitz" target="_blank" class="text-blue-500 text-2xl" title="Facebook"><i class="fab fa-facebook"></i></a>
            ...
            <a href="tel:+919944307413" class="text-blue-500 text-2xl" title="Call"><i class="fas fa-phone-alt"></i></a>
          </div>
