...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="legal-aspects-of-business-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/legal-aspects-of-business-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-teal-400');
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/legal-aspects-of-business-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/legal-aspects-of-business-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-teal-400 mb-2">Legal Aspects Of Business</h2>
                    <div class="mb-3">
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Legal Aspects of Business deals with laws and regulations governing commercial and corporate activities.</li>
                            <li>It covers the Indian Contract Act, which lays the foundation for valid contracts and agreements.</li>
                            <li>The Companies Act regulates incorporation, management, and dissolution of companies.</li>
                            <li>The Partnership Act and LLP Act govern partnership firms and limited liability partnerships.</li>
                            <li class="hidden" id="more-features">
                              Sale of Goods Act defines rights and duties of buyers and sellers in trade.<br>
                              Negotiable Instruments Act covers cheques, promissory notes, and bills of exchange.<br>
                              Consumer Protection Act ensures fair trade practices and safeguards consumer rights.<br>
                              Intellectual Property Rights (IPR) protect trademarks, patents, copyrights, and business innovations.
                              Labour laws regulate employer–employee relationships, wages, and workplace rights.
                              Knowledge of business law helps managers ensure compliance, avoid disputes, and make ethical decisions.
                            </li>
                        </ul>
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹998/-</span></p>

                        <span class="text-base text-gray-500 line-through ml-2">₹1098/-</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="legal-aspects-of-business-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-teal-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 63</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-teal-400 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
