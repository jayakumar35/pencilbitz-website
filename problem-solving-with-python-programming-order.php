...
<body class="bg-gray-100 ">
  <div class="row mx-auto">
    <nav class="mb-6 rounded-lg px-4 py-3">
     ...
     <li class="flex items-center">
      <a href="problun-solving-witpython-programming.php" class="hover:underline text-blue-600 flex items-center">
            <i class="fa-solid fa-network-wired"></i>
         problum-solving-with-python-programming
       </a>
      <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
    </li>
        <li class="flex items-center">
  ...
  <div class="flex items-center justify-center min-h-screen">
    <div style="background-image: none;"  class="container max-w-lg">
      <div class="bg-white shadow-xl rounded-lg p-8 flex flex-col items-center">
        <img src="assets/img/new/book-page/probleem-solving-with-python-programming-p3.png" class="w-100 h-auto rounded border-0 shadow-md mb-4" alt="Cloud Computing Book">
        <h2 id="book-name" class="text-2xl font-bold mt-2 mb-4 text-center"> problum-solving-with-python-programming </h2>
