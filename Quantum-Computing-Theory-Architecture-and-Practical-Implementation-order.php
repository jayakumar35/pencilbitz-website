            ...
            <ol class="flex items-center text-gray-700 space-x-2 text-sm font-medium">
                ...
                <li class="flex items-center">
                    <a href="/Quantum-Computing-Theory-Architecture-and-Practical-Implementation-book.php" class="hover:underline text-blue-600 flex items-center">
                        <i class="fas fa-code mr-1"></i>Quantum Computing: Theory, Architecture and Practical Implementation
                    </a>
                    <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
                </li>
                <li class="flex items-center">
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div style="background-image: none;" class="container max-w-lg">
            <div class="bg-white shadow-xl rounded-lg p-8 flex flex-col items-center">
                <img src="assets/img/new/book-page/Quantum-Computing-Theory-Architecture-and-Practical-Implementation-p3.png" class="w-100 h-auto rounded border-0 shadow-md mb-4" alt="Cloud Computing Book">
                <h2 id="book-name" class="text-2xl font-bold mt-2 mb-4">Quantum Computing: Theory, Architecture and Practical Implementation</h2>
