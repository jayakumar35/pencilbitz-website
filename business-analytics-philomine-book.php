...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="business-analytics-philomine-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/business-analytics-philomine-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/business-analytics-philomine-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/business-analytics-philomine-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-800 mb-2">Business Analytics</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> Dr. G Philomine Joan of Arc</li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-63-9| 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Gathers data from multiple sources like CRM, ERP, websites, and social media.</li>
                            <li>Example: Collecting customer feedback + sales data for analysis.</li>
                            <li>Converts raw data into graphs, dashboards, and charts.</li>
                            <li>Objects represent real-world entities with state and behavior</li>
                            <li class="hidden" id="more-features">
                                Tools: Power BI, Tableau, etc<br>
                                Uses historical data + machine learning to forecast future trends<br>
                                Example: Predicting future sales based on past patterns.<br>
                                Useful in dynamic sectors like finance or e-commerce.<br>
                    ...
                    <a href="business-analytics-philomine-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-sky-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
