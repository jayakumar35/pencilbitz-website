...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
       <a href="Cloud-Computing-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Cloud Computing Concepts and Fundamentals-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Cloud Computing Concepts and Fundamentals-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <div class="sm:text-center sm:mb-4">
            <h2 id="book-name" class="text-3xl font-semibold text-yellow-400 mb-2 sm:text-4xl sm:font-bold sm:text-gray-800">
              Cloud Computing Concepts and Fundamentals
            </h2>
          </div>
          <div class="mb-3">
            ...
            <ul class="list-disc list-inside text-gray-700">
              <li>PROF.SUMAIYA FATHIMA <br> DR.SANTHI K <br> DR.SONIA RIYAT <br> MES.G.NITHYA</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-11-0| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          ...
          <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
            <li>Comprehensive coverage of cloud computing concepts and fundamentals</li>
            <li>Clear explanations of service models: IaaS, PaaS, SaaS</li>
            <li>Detailed discussion on deployment models: Public, Private, Hybrid, Community</li>
            <li>Focus on virtualization, security, and cloud architecture</li>
            <li>Real-world examples and case studies</li>
            <li class="hidden" id="more-features">
              Includes practical exercises and review questions<br>
              Suitable for students and professionals<br>
              Written by experienced educators<br>
              Updated content for current industry trends<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="cloud-computing-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-500">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base p-1">
            ...
            <li><span class="font-semibold">Pages:</span> 183</li>
