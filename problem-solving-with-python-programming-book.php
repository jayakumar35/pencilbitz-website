...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="problem-solving-with-python-programming-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/probleem-solving-with-python-programming-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-blue-900');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-blue-900');
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/probleem-solving-with-python-programming-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2"> Problem Solving with Python Programming</h2>
          <div class="mb-3">
            ...
            <div class="flex flex-wrap gap-4 items-center mt-3">
              <!-- Flipkart -->
              <a href="https://www.flipkart.com/problem-solving-python-programming-1-disc/p/itm9f525a4785956?pid=9789348556554" target="_blank"
              ...
              <!-- Amazon -->
              <a href="https://www.amazon.in/dp/934855655X" target="_blank"
                ...
                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                  ...
                  <div id="downloadSection" class="mt-5 hidden">
                    ...
                    <div id="author1" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Problem Solving with Python Programming (2).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.Vijayalakshmi V - PDF</a>
                    </div>

                    <!-- Author 2 -->
                    <div id="author2" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Problem Solving with Python Programming (3).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Mr.Ghule Somnath Tukaram  - PDF</a>
                    </div>

                    <!-- Author 3 -->
                    <div id="author3" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Problem Solving with Python Programming (4).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.D.Kerana Hanirex - PDF</a>
                    </div>

                    <!-- Author 4 -->
                    <div id="author4" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Problem Solving with Python Programming (5).pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mrs.E.Sri Santhoshini - PDF</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- Book More Details -->
            ...
            <a href="problem-solving-with-python-programming-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-900 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>281</li>
