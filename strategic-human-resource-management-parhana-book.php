...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="strategic-human-resource-management-parhana-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/strategic-human-resource-management-parhana-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-sky-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-sky-800');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/strategic-human-resource-management-parhana-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/strategic-human-resource-management-parhana-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-800 mb-2">Strategic Human Resource Management</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> Ms.Parhana R  <br>  Dr.Hemasundari M  <br> Dr.K.Santhanalakshmi</li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-10-3| 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Strategic Human Resource Management (SHRM) is the advanced approach of managing people in alignment with an organization’s long-term goals.</li>
                            <li>It treats employees as key assets for achieving competitive advantage.</li>
                            <li>SHRM links HR practices directly with business strategies.</li>
                            <li>It focuses on talent acquisition, training, development, and retention.</li>
                            <li class="hidden" id="more-features">
                                The aim is to improve both individual and organizational performance.<br>
                                SHRM emphasizes proactive planning rather than just reactive HR functions.<br>
                               Employee engagement, motivation, and succession planning are central to SHRM.<br>
                                It requires strong collaboration between HR leaders and top management.
                               Overall, SHRM transforms HR from an administrative role into a strategic business partner.
                            </li>
                        </ul>
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1336/-</span></p>

                        <span class="text-base text-gray-500 line-through ml-2">₹1436/-</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="strategic-human-resource-management-parhana-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-sky-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
