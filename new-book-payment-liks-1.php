...
<body class="bg-gradient-to-br from-pencilbitz-light to-gray-100 font-sans min-h-screen p-4 sm:p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <header class="text-center mb-12 pt-8">
            ...
            <p class="text-gray-600 font-semibold text-sky-400 max-w-2xl mx-auto">Textbook </p>
        </header>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://www.linkedin.com/in/pencil-bitz-82556a276?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="bg-gray-700 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-pencilbitz-primary transition-colors">
