...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="basic-electrical-engineering-isha-das-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-isha-das-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-blue-800');
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-isha-das-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-isha-das-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-800 mb-2">Basic Electrical Engineering</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Isha Das <br> Jarin Joe Rini J <br>  Gopika B S <br> Swathi Sankepally</li>
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-47-9 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Basic Electrical Engineering studies electricity, circuits, machines, and power systems.</li>
                            <li>It explains concepts like current, voltage, resistance, and power.</li>
                            <li>Ohm’s Law (V = IR) is the foundation for analyzing circuits.</li>
                            <li>Electrical energy can be AC (alternating current) or DC (direct current).</li>
                            <li class="hidden" id="more-features">
                            AC is used in homes and industries, while DC is common in batteries and electronics.<br>
                            Key components include resistors, capacitors, inductors, and transformers.<br>
                            Electrical machines like motors and generators convert energy between electrical and mechanical forms.<br>
                            Power systems distribute electricity from generation plants to consumers.<br>
                            Safety rules (like grounding and circuit breakers) are essential to prevent accidents.
                            It forms the foundation for advanced fields like electronics, power engineering, and communication systems.
                            </li>
                        </ul>
                    ...
                    <a href="basic-electrical-engineering-isha-das-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 250</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-blue-800 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
