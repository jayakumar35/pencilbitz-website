...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title> Architecture and the Metaverse: Designing the future of Digital Space | Pencil Bitz Book </title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/architecture-and-the-metaverse-11-11-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/architecture-and-the-metaverse-11-11-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/architecture-and-the-metaverse-11-11-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/architecture-and-the-metaverse-11-11-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2">Architecture and the Metaverse: Designing the future of Digital Space </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Mr.R.Venkatesh
                                <br>Mrs.Quba Jaslin C
                                <br>Dr.L.Godlin Atlas
                                <br>Dr.K.V. Shiny
                            </li>
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-56-5| 2025 </span></div>
                            </li>
                        </ul>
                                ...
                                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Architecture and the Metaverse Designing the future of Digital Space a1 (1).pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mr.R.Venkatesh - PDF</a>
                                        </div>

                                        <!-- Author 2 -->
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Architecture and the Metaverse Designing the future of Digital Space a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Mrs.Quba Jaslin C - PDF</a>
                                        </div>

                                        <!-- Author 3 -->
                                        <div id="author3" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Architecture and the Metaverse Designing the future of Digital Space a3.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.L.Godlin Atlas- PDF</a>
                                        </div>

                                        <!-- Author 4 -->
                                        <div id="author4" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Architecture and the Metaverse Designing the future of Digital Space a4.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.K.V. Shiny- PDF</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="/architecture-and-the-metaverse-11-11-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        ...
                        Architecture and the Metaverse explore designing digital spaces that blend physical form with immersive, interoperable environments. It emphasizes spatial semantics, user experience, and accessibility across virtual and augmented realities. Designers leverage procedural generation, responsive avatars, and data-driven analytics to create scalable, adaptive habitats for work, play, and collaboration. Ethical considerations include inclusivity, privacy, and sustainability of server ecosystems and digital twins. The field integrates BIM-like workflows with real-time rendering, VR/AR prototyping, and cross-platform standards to ensure coherent, navigable architectures. This interdisciplinary approach reimagines space as a fluid, connective infrastructure shaping how communities interact online and offline.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>284 </li>
