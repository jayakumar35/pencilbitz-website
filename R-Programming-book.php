...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
      ...
      <li class="flex items-center">
          <a href="R-Programming-book.php" class="hover:underline text-blue-600 flex items-center">
            <i class="fas fa-code mr-1"></i> R Programming
          </a>
          <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
        </li>
      </ol>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/R Programming-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/R Programming-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-600 mb-2">R Programming</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li>DR.M.KAMAL <br> MR.Z.HARITH AHAMED <br> MR.L.IMAMDHEEN</li>
              <li><br>  <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-01-1| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
            ...
            <li>Open Source: Free to use, modify, and distribute.</li>
            <li>Large community support and active development.</li>
            <li>Efficient handling and storage of large datasets.</li>
            <li>Rich set of built-in data structures: vectors, matrices, data frames, and lists.</li>
            <li>Designed specifically for statistics and data analysis.</li>
            <li>Supports linear and nonlinear modeling, time-series analysis, clustering, and classification.</li>
            <li class="hidden" id="more-features">
              Extensive package ecosystem for specialized tasks.<br>
              Integrates easily with C, C++, Python, and other languages.<br>
              Powerful data visualization capabilities.<br>
              Widely used in academia and industry for statistical computing.
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="r-programming-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-700">
