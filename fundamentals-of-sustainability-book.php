...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="fundametals-of sustainability-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/fundamentals-of-sustainability-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/fundamentals-of-sustainability-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/fundamentals-of-sustainability-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-yellow-800 mb-2">  Fundamentals of Sustainability in Civil Engineering  </h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr. A. Tamilarasan <br> Dr. Dharanidharan S <br> Dr. Manikandan Periyasamy <br> Dr. Prem Kumar Vagestan </li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-36-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Sustainability in civil engineering focuses on balancing environmental, social, and economic needs.</li>
                <li>It promotes the use of eco-friendly materials and renewable resources in construction.</li>
                <li>Energy efficiency and waste reduction are core principles of sustainable design.</li>
                <li>Life-cycle assessment is used to evaluate the long-term impact of structures.</li>
                <li class="hidden" id="more-features">
                  Green building standards, such as LEED and BREEAM, guide sustainable practices.<br>
                   Water conservation and rainwater harvesting are integrated into infrastructure projects.<br>
                    Sustainable transport systems reduce carbon emissions and promote mobility.<br>
                    Engineers emphasize resilience to climate change and natural disasters.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="fundamentals-of-sustainability-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
