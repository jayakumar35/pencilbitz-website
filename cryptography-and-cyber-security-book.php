...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title>Cryptography and Cyber Security |Pencil Bitz Book </title>
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-2 py-2 sm:px-4 sm:py-3">
      <ol class="flex flex-col sm:flex-row flex-wrap items-start sm:items-center text-gray-700 space-y-1 sm:space-y-0 sm:space-x-2 text-sm font-medium">
        <li class="flex items-center">
          <a href="index.php" class="hover:underline text-blue-600 flex items-center">
            <i class="fas fa-home mr-1"></i> Home
          </a>
          <span class="mx-2 text-gray-400 hidden sm:inline"><i class="fas fa-chevron-right"></i></span>
        </li>
        <li class="flex items-center">
        ...
        <li class="flex items-center">
          <a href="cryptography-and-cyber-security-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Cryptography and Cyber Security-II-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Cryptography and Cyber Security-II-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-500 mb-2">Cryptography and Cyber Security</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="">Dr.B.Dhanasekaran <br> Dr.J.Jaganpradeep <br> M.Chamundeeswari <br> Mr. Pradip Sitaram Ingle</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-37-0| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
            ...
            <li>Confidentiality – Keeps data secret from unauthorized users.</li>
            <li>Integrity – Ensures data is not altered during transmission.</li>
            <li>Authentication – Verifies the identity of users or systems.</li>
            <li class="hidden" id="more-features">
              Non-repudiation – Prevents denial of sending or receiving data.<br>
              Covers both symmetric and asymmetric cryptography.<br>
              Symmetric: Same key for encryption and decryption (e.g., AES).<br>
              Asymmetric: Public key for encryption, private key for decryption.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="cryptography-and-cyber-security-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-500">
