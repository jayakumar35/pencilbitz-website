...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="principles-of-management-thangaimani-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/principles-of-management-thangaimani-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/principles-of-management-thangaimani-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/principles-of-management-thangaimani-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-pink-400 mb-2">Principles of Management</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> Dr.S.Thanigaimani <br> Dr.M.Manimekalai</li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-60-8 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Division of Work – Specialization improves efficiency and productivity.</li>
                            <li>Authority and Responsibility – Managers must have authority to give orders and take responsibility.</li>
                            <li>Discipline – Employees should respect rules and agreements for smooth functioning.</li>
                            <li>Unity of Command – Each employee should receive orders from only one superior.</li>
                            <li class="hidden" id="more-features">
                              Unity of Direction – Activities with the same objective should be guided by one plan.<br>
                              Subordination of Individual Interest to General Interest – Organizational goals are more important than personal interests.<br>
                              Remuneration – Fair pay motivates employees and increases satisfaction.<br>
                    ...
                    <a href="principles-of-management-thangaimani-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-pink-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
