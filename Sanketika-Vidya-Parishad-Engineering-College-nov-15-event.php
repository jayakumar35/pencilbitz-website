    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0 text-center">
                <img src="assets/img/upcomeing-event/Sanketika-Vidya-Parishad-Engineering-College-nov-15.jpg" 
            ...
            <div class="col-lg-6 col-md-12">
                <div class="event-content px-2 position-relative">
                    ...
                    <h1 class="text-red-500 fw-semibold mb-3">Advanced AI Tools For The Outcome Based Education as per NAP 2021</h1>

                    <h3 class="text-gray-500">Details</h3>
                    <ul class="list-unstyled mb-4">
                        <li class="mb-2"><i class="fas fa-calendar-alt me-2 text-primary"></i> <strong>Date:</strong> 15 November 2025</li>
                    ...
                    <div class="d-flex justify-content-between flex-wrap gap-3">
                        <a  class="btn text-gray-800 font-semibold py-2 px-4 rounded shadow d-inline-flex align-items-center gap-2" href="https://forms.gle/WYZfQZdg7QuTaRSF6" 
