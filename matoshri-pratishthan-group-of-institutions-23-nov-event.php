                ...
                <div class="col-lg-6 col-md-12">
                    <div class="event-content px-2">
                        ...
                        <ul class="list-unstyled mb-4 ps-3 ">
                            ...
                            <li class="mb-2"><i class="fas fa-clock text-primary me-2"></i> <strong>Time:</strong> 02:00 PM To :00PM </li>

                            <li class="mb-2"><i class="fas fa-map-marker-alt text-primary me-2"></i> <strong>Location:</strong>Tamil Nadu</li>
