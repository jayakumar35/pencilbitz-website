...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="digital-communication-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/digital communication-sep24.jpg"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/digital communication-b-sep24.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-red-600 mb-2">Digital Communication</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
            ...
            <li>Instant transmission of information across the globe.</li>
            <li>Reduces time delays in communication.</li>
            <li>Supports text, images, audio, video, and animations.</li>
            <li>Enables richer and more engaging communication.</li>
            <li class="hidden" id="more-features">
             Lower cost compared to traditional communication (e.g., letters, phone calls).<br>
             Especially economical for long-distance communication.<br>
              Accessible 24/7 through various devices (smartphones, laptops, tablets).<br>
             Information can be retrieved or sent anytime, anywhere.<br>
             Messages and data can be stored digitally for future use.
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹325</span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹425</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="digital-communication-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-red-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-red-800">
