...
<body class="bg-black font-sans min-h-screen flex items-center justify-center p-4 sm:p-6">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-soft overflow-hidden border border-gray-100">
        ...
        <div class="qr-container p-6 sm:p-8 flex flex-col items-center">
            <div class="w-56 h-56 bg-white rounded-xl mb-5 flex items-center justify-center shadow-hard">
                ...
                <div class="w-full h-full flex items-center justify-center p-1">
                    <img src="assets/img/Sangeetha-Pay-QR.jpeg" 
                        alt="UPI QR Code" class="w-full h-full object-contain rounded-lg">
                </div>
            </div>
            
            <div class="text-center w-full">
                <h1 class="text-gray-800 text-xl font-semibold mb-3 tracking-tight">SANGEETHA</h1>
                <div class="flex upi-container items-center justify-center">
                    <div class="bg-white bg-opacity-20 rounded-lg px-4 py-2 upi-id">
                        <p id="upi-id" class="text-gray-800 font-medium text-sm sm:text-base truncate max-w-xs">sangeethakncet-4@oksbi</p>
                    </div>
        ...
        <div class="mx-6 my-4 bg-pencilbitz-light rounded-xl p-3 border border-gray-200 shadow-inner">
            ...
            <div class="space-y-3">
                <!-- Phone -->
               <ul >
                <li class="font-medium text-md text-gray-800" ><strong>Account Holder:</strong><span> SANGEETHA S  </span></li>
                <li class="font-medium text-md text-gray-800" ><strong>Account Number:</strong><span> 50200090944020 </span></li>
