...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="fundamentals-of-iot-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/fundamentals-of-iot-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-red-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-red-800');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/fundamentals-of-iot-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/fundamentals-of-iot-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-red-800 mb-2"> Fundamentals of IOT</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Mr.Sankara Rao Allada <br> Ms.Navya Sai <br> Ms.Manasa.S <br> Dr.R.Raman </li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-49129-31-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>IoT refers to a network of physical devices connected via the internet to collect and share data.</li>
                <li>It integrates sensors, actuators, and embedded systems for real-time monitoring and control.</li>
                <li>Connectivity technologies like Wi-Fi, Bluetooth, Zigbee, and 5G enable seamless communication.</li>
                <li>IoT architecture typically consists of perception, network, edge, and application layers.</li>
                <li class="hidden" id="more-features">
                   Cloud computing plays a major role in storing and analyzing IoT-generated data.<br>
                    Security and privacy are crucial challenges due to massive data exchange.<br>
                    IoT applications span across smart homes, healthcare, agriculture, transportation, and industry.<br>
                    Protocols such as MQTT, CoAP, and HTTP ensure device interoperability and communication.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="fundamentals-of-iot-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-red-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span> 293</li>
