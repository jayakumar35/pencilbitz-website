...
<head>
    ...
    <title>Acharya Institute Of Graduate Studies Event Certificate | Pencil Bitz </title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mb-6 lg:mb-0">
                        <div class="d-flex justify-content-center align-items-start h-auto">
                            <img src="assets/img/upcomeing-event/acharya-institute-of-graduate-studies-nov-21.jpg" alt="Event Image" class="w-full max-h-[700px] object-cover rounded-xl shadow-xl transition-transform duration-500 hover:scale-[1.01]">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="event-content px-2">
                            ...
                            <h2 class="text-2xl font-semibold text-red-600 mb-6 pl-3">Big Data Analytics & Data Mining Trends</h2>
                            ...
                            <ul class="space-y-4 mb-8 text-gray-700 font-medium">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Date:</strong> 21 November 2025
                                    </div>
                                </li>
                                <li class="flex items-start">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Location:</strong> Bengaluru
                                    </div>
                                </li>
                                <li class="flex items-start">
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <a href="assets/img/event-certificate/Acharya Participants Certificates.pdf" class="register-button inline-flex items-center justify-center bg-sky-500 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-sky-600 transition-colors duration-300" download="">
