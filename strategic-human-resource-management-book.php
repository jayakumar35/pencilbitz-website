    ...
    <li class="flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Strategic Human Resource Management-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Strategic Human Resource Management-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-pink-600 mb-2">Strategic Human Resource Management</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr. B. SIVARAJ  MBA., Ph.D</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-69-1| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          ...
          <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
            <li>Comprehensive coverage of strategic HRM concepts and practices.</li>
            <li>Real-world case studies and examples for practical understanding.</li>
            <li>Focus on aligning HR strategies with organizational goals.</li>
            <li>Includes latest trends and challenges in HRM.</li>
            <li class="hidden" id="more-features">
              Detailed discussion on talent management and workforce planning.<br>
              Insights into performance management and employee engagement.<br>
              Covers legal and ethical aspects of HRM.<br>
              Useful for students, professionals, and HR practitioners.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="strategic-human-resource-management-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-pink-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-pink-800">
