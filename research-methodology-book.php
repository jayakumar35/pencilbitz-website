...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
      ...
      <li class="flex items-center">
         <a href="Research-Methodology-book.php" class="hover:underline text-blue-600 flex items-center">
           <i class="fas fa-flask mr-1"></i> Research Methodology
         </a>
         <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
       </li>
          </ol>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Research Methodology-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Research Methodology-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-500 mb-2">Research Methodology</h2>
          <div class="mb-3">
            ...
            <ul class="list-disc list-inside text-gray-700">
              ...
              <li>
                <br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-11-0| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            ...
            <li>Follows a systematic and structured research process</li>
            <li>Includes clear steps: problem identification, data collection, analysis, and interpretation</li>
            <li>Emphasizes minimizing bias and ensuring objectivity</li>
            <li class="hidden" id="more-features">
              Utilizes evidence-based and logical reasoning<br>
              Focuses on observable, measurable, and verifiable data<br>
              Ensures methods are transparent and reproducible<br>
              Facilitates critical thinking and informed decision-making<br>
              Supports validation and reliability of research outcomes
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="Research-Methodology-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-orange-700">
