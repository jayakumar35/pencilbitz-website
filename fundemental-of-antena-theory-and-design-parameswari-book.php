...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title> Fundamentals of Antenna Theory and Design | pencil Bitz Books </title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="fundemental-of-antena-theory-and-design-parameswari-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/fundemental-of-antena-theory-and-design-10-11-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/fundemental-of-antena-theory-and-design-10-11-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/fundemental-of-antena-theory-and-design-10-11-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2">Fundamentals of Antenna Theory and Design </h2>
                    <div class="mb-3">
                        ...
                        <ul class="list-disc list-inside text-gray-700">
                            ...
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-80-0| 2025 </span></div>
                            </li>
                        </ul>
                    ...
                    <a href="fundemental-of-antena-theory-and-design-parameswari-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800  ">Fundamentals of Antenna Theory and Design explore how antennas convert electrical signals into electromagnetic waves and vice versa, focusing on principles like radiation patterns, impedance matching, polarization, and gain. Designers analyze current distribution on radiating elements to predict far-field behavior and optimize parameters such as bandwidth and directivity for specific applications. Key performance metrics include efficiency, beamwidth, and signal-to-noise considerations, all influenced by element shape, size, and environment. Practical design also requires attention to feed mechanisms and matching networks to minimize reflections and power loss. Advances in materials, simulation tools, and computational electromagnetics have streamlined the transition from concept to prototype. Understanding these fundamentals enables engineers to create antennas tailored for communications, radar, sensing, and emerging wireless systems.
                    </p>
                </div>
