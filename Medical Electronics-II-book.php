...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="Medical Electronics-II-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Medical Electronics-II-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-blue-950');
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Medical Electronics-II-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/Medical Electronics-II-p3.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          ...
          <img
        src="assets/img/new/book-page/Medical Electronics-II-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-950 mb-2">Medical Electronics-II</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr.P.Chinniah <br> R.Dinesh Kumar</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-06-6| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Comprehensive coverage of Medical Electronics-II syllabus for engineering students.</li>
                <li>Detailed explanations of biomedical sensors, amplifiers, and transducers.</li>
                <li>Illustrates diagnostic and therapeutic equipment with real-world examples.</li>
                <li>Focus on safety standards, regulations, and recent advancements in medical electronics.</li>
                <li class="hidden" id="more-features">
                    Includes solved problems, review questions, and practical applications.<br>
                    Covers ECG, EEG, EMG, and imaging systems in detail.<br>
                    Suitable for students, educators, and professionals in biomedical engineering.<br>
                    Authored by experienced faculty with industry insights.<br>
                    Features diagrams, tables, and case studies for enhanced learning.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="Medical Electronics-II-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-950 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
        ...
        <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
          <div class="flex gap-4 text-center ps-5">
