            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
              ...
              <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                            ...
                            <div id="certificatePopup"
                                ...
                                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                                    ...
                                    <label class="block mb-3">
                                        <span class="text-sm text-gray-600">Enter Point of Author Phone Number</span>
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Intellectual Property Rights a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.Jemimah Winston - PDF</a>
                                        </div>

                                        <!-- Author 2 -->
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Intellectual Property Rights a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Dr.Mobi Rajendran- PDF</a>
                                        </div>

                                        <!-- Author 3 -->
                                        <div id="author3" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Intellectual Property Rights a3.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Dr. Jenifer Thangam J - PDF</a>
                                        </div>
                    ...
                    <a href="intellectual-property-rights-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2">
                        <span class="font-medium text-gray-800">Intellectual Property Rights (IPR) protect creations of the mind such as inventions, designs, artistic works, and symbols. They include patents, copyrights, trademarks, and trade secrets. IPR encourages innovation and creativity by granting creators exclusive rights to use and profit from their work while preventing unauthorized use by others.
                    </p>
                </div>
