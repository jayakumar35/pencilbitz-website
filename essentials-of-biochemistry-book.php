...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/essentials-of-biochemistry-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-teal-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-teal-800');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/essentials-of-biochemistry-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/essentials-of-biochemistry-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-teal-800 mb-2">Essentials of Biochemistry</h2>
                    <div class="mb-3">
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Biochemistry is the study of chemical processes in living organisms.</li>
                            <li>It explains how biomolecules like carbohydrates, proteins, lipids, and nucleic acids function.</li>
                            <li>Enzymes act as biological catalysts, speeding up biochemical reactions.</li>
                            <li>Carbohydrates provide energy and structural support.</li>
                            <li class="hidden" id="more-features">
                              Proteins play roles in structure, transport, defense, and regulation.Lipids store energy, form membranes, and act as signaling molecules.<br>
                              Nucleic acids (DNA & RNA) store and transfer genetic information Metabolism includes catabolism (breaking down molecules for energy) and anabolism (building molecules).<br>
                              Biochemical pathways (like glycolysis, Krebs cycle) are essential for energy production.<br>
                            Biochemistry connects biology and chemistry, helping us understand health, disease, and drug development.
                            </li>
                        </ul>
                    ...
                    <a href="essentials-of-biochemistry-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-teal-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 201</li>
