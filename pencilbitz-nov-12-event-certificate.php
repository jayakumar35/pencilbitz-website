...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title> Pencil Bitz Event Certificate</title>
        ...
        lucide.createIcons();
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <ul class="list-unstyled mb-4 ps-3 ">
                    ...
                    <!-- <li class="mb-2"><i class="fas fa-map-marker-alt text-primary me-2"></i> <strong>Location:</strong></li> -->
                ...
                <a href="#" class="bg-gray-200 hover:bg-green-300 hover:text-gray-800 rounded-2 text-gray-800 shadow-lg fw-bold px-4 py-2">
                 ...
                 <a href="assets/img/event-certificate/Pencilbitz Participants Certificates.pdf" class="bg-sky-400 hover:bg-sky-300 hover:text-gray-800 rounded-2 text-gray-800 shadow-lg fw-bold px-4 py-2 ms-5" download="" >Download Certificate</a>
                </div>
                <div class="">
                    <p class="mt-4 ">
