...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="smart-farming-an-iot-approach-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/smart-farming-an-iot-approach-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-lime-600');
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/smart-farming-an-iot-approach-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/smart-farming-an-iot-approach-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-lime-600 mb-2">Smart Farming An IoT Approach</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Prof.Sneh A. Nagaonkar  <br> Dr.Sudhakar D.Bhoite</li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-44-8 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Smart farming uses the Internet of Things (IoT) to enhance agricultural productivity and efficiency.</li>
                            <li>IoT devices like sensors, drones, and automated systems collect real-time data on soil, crops, and weather.</li>
                            <li>Soil moisture sensors help optimize irrigation and reduce water wastage.</li>
                            <li>Smart farming enables precision agriculture by applying fertilizers and pesticides only where needed.</li>
                            <li class="hidden" id="more-features">
                            Data analytics and AI provide farmers with insights for better decision-making.<br>
                            Livestock monitoring through IoT ensures animal health and efficient farm management.<br>
                            Remote monitoring allows farmers to track farm conditions anytime, anywhere.<br>
                            IoT reduces labor costs and improves yield quality through automation.<br>
                            Challenges include high setup costs, connectivity issues, and data security.
                            </li>
                        </ul>
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹901/-</span></p>

                        <span class="text-base text-gray-500 line-through ml-2">₹1001/-</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="smart-farming-an-iot-approach-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-lime-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 122</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-lime-600 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
