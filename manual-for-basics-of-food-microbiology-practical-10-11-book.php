...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/manual-for-basics-of-food-microbiology-practical-10-11-book.php" class="hover:underline text-blue-600 flex items-center">
                            <i class="fas fa-building mr-1"></i>
                            <i class="fas fa-coins mr-1"></i>
                            A Manual For Basics of Food Microbiology
                        </a>
                        <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
                    </li>
                </ol>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/a-manual-for basic-of-food-microbiolagy-10-11-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/a-manual-for basic-of-food-microbiolagy-10-11-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/a-manual-for basic-of-food-microbiolagy-10-11-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2"> A Manual For Basics of Food Microbiology </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> M.C. Anitha
                                <br> R. Kalamani
                                <br> C.Ajitha
                            </li>
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-973083-3-8| 2025 |</span></div>
                            </li>
                        </ul>
 ...
 -->
          ...
          class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Dr. David Raj - JPG</a> -->
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹249</span></p>

                        <span class="text-base text-gray-500 line-through ml-2">₹349</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="/manual-for-basics-of-food-microbiology-practical-10-11-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2">
                        ...
                        A manual on food microbiology covers the principles of microbial ecology, safety, and quality in food systems. It explains how microorganisms influence fermentation, spoilage, fermentation, and shelf life, with practical controls to ensure safety. The text outlines detection, enumeration, and identification methods, along with standard pasteurization, sanitation, and HACCP principles. It emphasizes common foodborne pathogens, risk assessment, and regulatory guidelines to protect public health. Analytical techniques, culture methods, and rapid tests are described for routine lab work and quality control. The manual integrates theory with hands-on procedures to equip students and professionals for responsible food microbiology practice.
                    </p>
                </div>
