<footer style=" max-width:1520px;background-color: #20263E;" class="w-full  shadow-lg rounded-2   ">
    <div class="mx-auto max-w-8xl px-4 sm:px-6 lg:px-10">
        <!--Grid-->
        <div class="grid grid-cols-12 gap-3 mt-5 lg:grid-cols-8">
            <div class="mb-0 col-span-full lg:col-span-2 ">
                <div class="flex items-center ">
                    <!-- Logo -->
                    <a href="index.php" class="flex items-center">
                        <img src="assets/img/new-logo-pencilbitz.jpg" alt="Company Logo"
                            class="h-20 w-auto ms-3 rounded-5  " style="max-width:210px; max-height: 65px;">
                    </a>
                    <h2 class="text-4xl font-medium text-red-500 font-mono">P <h3 class="text-3xl text-white font-medium  text font-sans">encil&nbsp;Bitz</h3>
                    </h2>

                </div>
                <p class="text-white mt-4 text-justify">
                    Welcome to PencilBitz – your trusted partner for publication and patent grant services. We help innovators and researchers bring their ideas to life.
                </p>
            </div>
            <!--End Col-->
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                <h4 class="text-lg text-blue-500 font-medium mb-7">Our Company</h4>
                <ul class="text-gray-600  transition-all duration-500">
                    <a href="our-company.php">
                        <li class="mb-6 text-white">About us</li>
                    </a>
                    <a href="contact.php">
                        <li class="mb-6 text-white">Contact us</li>
                </ul></a>
            </div>
            <!--End Col-->
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-2">
                <h4 class="text-lg text-blue-500 font-medium mb-7">Our Services</h4>
                <ul class="text-gray-600 transition-all duration-700  ">
                    <li class="mb-6"><a href="book-store.php" class="text-white hover:text-gray-900">Patent Grant Support</a></li>
                    <li class="mb-6"><a href="Publications.php" class=" text-white hover:text-gray-900">Text Book Publication</a></li>
                    <li class="mb-6"><a href="event.php" class=" text-white hover:text-gray-900">Journal Publication</a></li>
                    <li class="sm:mb-6"><a href="patent.php" class=" text-white hover:text-gray-900">PhD Assistance</a></li>
                    <li class="sm:mb-6"><a href="patent.php" class=" text-white hover:text-gray-900">Academic Events Management</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                <h4 class="text-lg text-center text-blue-600 font-medium mb-7 lg:text-left">News letter</h4>
                <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                    ...
                    <a href="https://www.linkedin.com/in/pencil-bitz-82556a276?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" class="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#0077B5] hover:bg-gray-900">
                        <svg class="w-[1.25rem] h-[1.25rem] text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-white mt-4 text-justify">
                    <strong class="text-green-200">Address:</strong>
                    92 A, Sanganoor Rd,
                    Ganapathy, Coimbatore,
                    Tamil Nadu 641006
                </p>
                 <div class="mt-4 text-sm text-gray-600">
                <span class="font-semibold text-white">Contact:+91 99443 07413  </span> |<br> <span class="font-semibold text-white">Email: pencilbitz@gmail.com</span> 
            </div>
    ...
    <!--Grid-->
    <div class="py-2 border-t border-gray-200 p-3 ">
        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <p class="text-white py-0">&copy; Copyright <?php echo date('Y'); ?>. <a href="https://www.pencilbitz.com">pencilbitz</a></p>
            <ul class="flex items-center gap-9 mt-4 lg:mt-0 py-2">
                <li><a href="javascript:;" class="text-sm text-white">Terms</a></li>
                <li><a href="javascript:;" class="text-sm text-white">Privacy</a></li>
                <li><a href="javascript:;" class="text-sm text-white">Cookies</a></li>
            </ul>
        </div>
    </div>
    </div>
