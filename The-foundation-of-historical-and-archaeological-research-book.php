...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>The foundation of historical and archaeological research | Pencil Bitz Books</title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/The-foundation-of-historical-and-archaeological-research-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/The-foundation-of-historical-and-archaeological-research-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/The-foundation-of-historical-and-archaeological-research-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/The-foundation-of-historical-and-archaeological-research-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">The foundation of historical and archaeological research </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="">Dr.venkatesh UR
                               
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-51-0| 2025</span></div>
                            </li>
                        </ul>
                        <div class="flex flex-wrap gap-4 items-center mt-3">

               <!-- Flipkart -->
              <a href="https://www.flipkart.com/foundation-historical-archaeological-research-1-disc/p/itm8af7c1a3f0578?pid=9789389911510" target="_blank"
              ...
              <!-- <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                            ...
                            <div id="certificatePopup"
                                ...
                                <br>
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/The foundation of historical and archeological research a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.venkatesh UR- PDF</a>
                                        </div>
                    ...
                    <a href="/The-foundation-of-historical-and-archaeological-research-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800">The foundation of historical and archaeological research lies in the systematic study of past human activities through written records, material remains, and scientific analysis. History relies on documents, inscriptions, and narratives, while archaeology examines artifacts, structures, fossils, and cultural landscapes. Together, they provide complementary evidence, enabling researchers to reconstruct ancient societies, understand cultural evolution, and interpret human behavior across time with accuracy and depth.Ac
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>199</li>
