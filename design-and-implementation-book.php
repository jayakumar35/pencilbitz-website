    ...
    <li class="flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/design-and-implementation-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-yellow-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-yellow-800');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/design-and-implementation-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/design-and-implementation-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-yellow-800 mb-2">  Design and Implementation of Smart Inverters for Solar Energy Grid Integration </h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Mr.John De Britto C <br> Dr.Mamidala Vijay Karthik <br> Mr.P.Manikandan <br> Mr.Mahendiran C R </li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-07-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Role of Smart Inverters – Unlike conventional inverters, smart inverters provide advanced grid-support functions such as voltage regulation, frequency stabilization, and reactive power control.</li>
                <li>Grid Integration – Enable seamless integration of solar PV systems into the power grid while maintaining grid stability and reliability.</li>
                <li>Voltage & Frequency Control – Smart inverters can dynamically adjust output to support grid voltage and frequency, preventing fluctuations caused by variable solar generation.</li>
                <li>Communication Capabilities – Equipped with communication interfaces (e.g., IoT, SCADA, IEEE 2030.5) to exchange real-time data with utilities for monitoring and control.</li>
                <li class="hidden" id="more-features">
                  Power Quality Improvement – Reduce issues such as harmonics, flicker, and imbalance, thereby enhancing overall grid power quality.<br>
                   Anti-Islanding Protection – Automatically disconnect during grid faults or outages to ensure safety and compliance with standards.<br>
                    Energy Management – Enable functions like peak shaving, load shifting, and integration with energy storage systems.<br>
                    Cybersecurity & Standards – Must comply with grid codes (IEEE 1547, IEC standards) and implement secure communication protocols.<br>
                  Recycling and reuse of construction materials minimize environmental damage.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1448</span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹1548</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="design-and-implementation-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>261</li>
