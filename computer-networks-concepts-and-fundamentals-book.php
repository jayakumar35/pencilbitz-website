...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title>Computer Networks Concepts And Fundamentals | Pencil Bitz Books</title>
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="computer-networks-concepts-concepts-and-fundamentals-book.php" class="hover:underline text-blue-600 flex items-center">
      <i class="fa-solid fa-network-wired"></i>
      Computer Networks Concepts And Fundamentals
      </a>
      <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
    </li>
    </ol>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/computer-networks-concepts-and-fundamentals-1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/computer-networks-concepts-and-fundamentals-2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/computer-networks-concepts-and-fundamentals-3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-600 mb-2"> Computer Networks Concepts And Fundamentals</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="">K. Kalaichelve <br> Dr. Varalashmi K R <br> Dr. N.Gayathri Devi <br> Dr.Vimala D</li>
        ...
        <div class="mt-3 border-t pt-2">
            ...
            <li>LAN (Local Area Network) – Covers a small area like a home or office.</li>
            <li>MAN (Metropolitan Area Network) – Covers a city.</li>
            <li>WAN (Wide Area Network) – Covers large geographical areas (e.g., the Internet).</li>
            <li>PAN (Personal Area Network) – Short-range network like Bluetooth.</li>
            <li class="hidden" id="more-features">
              Bus – Single cable shared by all devices.<br>
              Star – All devices connected to a central hub.<br>
              Ring – Devices connected in a circular fashion.<br>
              Mesh – Devices are interconnected.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1436</span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹1536</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="computer-networks-concepts-and-fundamentals-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
