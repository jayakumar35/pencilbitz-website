...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="natwork-and-security-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/network-and-security-p1.png"
        ...
        onclick="
          ...
          this.classList.remove('border-cyan-800');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/network-and-security-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/network-and-security-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-cyan-800 mb-2"> Network and Security </h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Covers OSI and TCP/IP models, IP addressing, subnetting, and routing concepts.</li>
                <li>Explains LAN, WAN, VPN, and wireless networking in detail.</li>
                <li>Detailed insights into routers, switches, firewalls, and network topologies.</li>
                <li>Explains common protocols such as HTTP, HTTPS, DNS, DHCP, FTP, and SNMP.</li>
                <li class="hidden" id="more-features">
                 Introduction to core security principles: Confidentiality, Integrity, and Availability (CIA triad).<br>
                  Covers authentication, authorization, and encryption methods.<br>
                   Identifies common cyber threats like malware, phishing, ransomware, and DoS attacks.<br>
                    Automation: Automates switching, load balancing, and preventive maintenance.<br>
                 Discusses vulnerability assessment and penetration testing techniques.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="network-and-security-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-cyan-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
