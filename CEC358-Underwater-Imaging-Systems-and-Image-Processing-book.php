...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>CEC358-Underwater Imaging Systems and Image Processing| Pencil Bitz Book</title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/CEC358-Underwater-Imaging-Systems-and-Image-Processing-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/CEC358-Underwater-Imaging-Systems-and-Image-Processing-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/CEC358-Underwater-Imaging-Systems-and-Image-Processing-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/CEC358-Underwater-Imaging-Systems-and-Image-Processing-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">CEC358-Underwater Imaging Systems and Image Processing</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="">Mrs.Muppudhathi Sutha.S <br> 
                              Dr. S.D.Jayavathi <br>
                              Mr.Vinoth Rajkumar G <br>
                              Ms.P.Stella Rose Malar
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-993118-5-5| 2025</span></div>
                            </li>
                        </ul>
              ...
              <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mrs.Muppudhathi Sutha.S - PDF</a>
                                        </div>
                                        ...
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr. S.D.Jayavathi - PDF</a>
                                        </div>
                                              <!-- Author 2 -->                                   <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700"> Mr.Vinoth Rajkumar G - PDF</a>
                                        </div>
                                         <!-- Author 2 -->
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/Probability and Queueing Theory a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Ms.P.Stella Rose Malar - PDF</a>                         
                    ...
                    <div class="text-2xl font-bold text-purple-900 mb-3">
                        <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1351/-</span></p>

                        <span class="text-base text-gray-500 line-through ml-2">₹1451/-</span>
                        <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
                    </div>
                    <a href="/CEC358-Underwater-Imaging-Systems-and-Image-Processing-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800">CEC358 – Underwater Imaging Systems and Image Processing focuses on the principles and technologies used to capture and analyze images in underwater environments. The course covers light propagation in water, image degradation factors, and the use of specialized sensors such as sonar, lidar, and underwater cameras. It includes restoration, enhancement, noise reduction, and color correction techniques. Students learn algorithms for object detection, feature extraction, and underwater vision applications used in marine research, robotics, navigation, and environmental monitoring.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>320</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4 ps-5">
                        <a href="https://wa.me/917200741307?text=Hello%2C%20I%20would%20like%20to%20order%20Cloud%20Computing%20book." target="_blank" class="text-green-600 text-2xl" title="WhatsApp"><i class="fab fa-whatsapp"></i></a>
                        ...
                        <a href="tel:+917200741307" class="text-blue-600 text-2xl" title="Call"><i class="fas fa-phone-alt"></i></a>
                    </div>
