  ...
  <div class="container mx-auto px-4 py-8">
    <nav class="mb-6 rounded-lg px-4 py-3">
      <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
        ...
        <li class="flex items-center">
          <a href="deeplearning-business-book.php" class="hover:underline text-blue-600 flex items-center">
    ...
    <div class="flex justify-center items-center min-h-[70vh]">
      <div class="w-full max-w-lg">
        <div class="bg-white shadow-xl rounded-lg p-8 flex flex-col items-center">
          <img src="assets/img/new/book-page/Deep Learning-p1.png" class="w-full h-auto rounded border-0 shadow-md mb-4" alt="Cloud Computing Book">
          <h2 id="book-name" class="text-2xl font-bold mt-2 mb-4 text-center text-gray-500 ">Deep Learning for Business Analytics Beginner's Handbook</h2>
          <h2 class="fw-bold fs-3 text-gray-800 mb-3 text-center">Book Order</h2>
          ...
          <div class="custom-icons mt-4 flex justify-center space-x-6">
