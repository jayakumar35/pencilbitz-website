...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="mastering-artifical-intelligence-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/mastering-artifical-intelligence-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-yellow-900');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-yellow-900');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/mastering-artifical-intelligence-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/mastering-artifical-intelligence-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-yellow-900 mb-2"> Mastering Artificial Intelligence: Comphernsive Guide to Modern AI Technologies</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Explains AI from basic concepts to advanced modern technologies in a structured manner.</li>
                <li>Includes real-world examples, case studies, and applications in multiple industries.</li>
                <li>Covers AI fundamentals, machine learning, deep learning, and NLP with progressive difficulty.</li>
                <li>Demonstrates practical coding exercises using Python, TensorFlow, PyTorch, and Scikit-learn.</li>
                <li class="hidden" id="more-features">
                  Discusses cutting-edge topics such as Generative AI, Large Language Models (LLMs), and Quantum AI.<br>
                   Highlights the importance of fairness, transparency, and accountability in AI development.<br>
                    Cloud Storage & Analytics: Stores data on cloud platforms for visualization and decision-making.<br>
                    Contains diagrams, charts, and visual explanations for complex algorithms.<br>
                 Highlights the importance of fairness, transparency, and accountability in AI development
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="mastering-artifical-intelligence-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-900 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
