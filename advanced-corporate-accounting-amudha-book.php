...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="advanced-corporate-accounting-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/advanced-corporate-accounting-amudha-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/advanced-corporate-accounting-amudha-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/advanced-corporate-accounting-amudha-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-amber-800 mb-2">Advanced Corporate Accounting</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr.S.AMUDHA  <br> Dr.S.K.ARUNKUMAR</li>
              <li>
                <br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-34-9| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Corporate Restructuring – Covers mergers, acquisitions, amalgamations, and internal reconstructions in corporate entities.</li>
                <li>Consolidated Financial Statements – Focuses on preparing and analyzing group accounts for holding and subsidiary companies.</li>
                <li>Valuation of Goodwill and Shares – Explains methods for determining business value during mergers or takeovers.</li>
                <li>Accounting for Liquidation – Details procedures for preparing statements of affairs and deficiency accounts during company winding up.</li>
                <li class="hidden" id="more-features">
           Amalgamation and Absorption Accounting – Demonstrates journal entries and balance sheet treatments as per accounting standards.<br>
              Accounting Standards Compliance – Emphasizes IFRS, AS, and Ind AS for accurate and transparent reporting.<br>
              Corporate Governance and Disclosure – Highlights ethical practices, transparency, and stakeholder communication in financial reporting.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="advanced-corporate-accounting-amudha-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-amber-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
