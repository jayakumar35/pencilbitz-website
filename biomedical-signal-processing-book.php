...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="boimedical-singnal-processing-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/biomedical-signal-processing-and-analysis-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-teal-600');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-teal-600');
          this.classList.add('border-gray-600');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/biomedical-signal-processing-and-analysis-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/biomedical-signal-processing-and-analysis-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-teal-600 mb-2">  Biomedical Signal Processing and Analysis: ECG & EEG Perspectives</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">	Dr.Manjunatha Siddappa,  <br> Mr.Ravi M V</li>
              <li>
                <br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-17-2| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Focus on Physiological Signals – Emphasizes acquisition, processing, and interpretation of biomedical signals such as Electrocardiogram (ECG) and Electroencephalogram (EEG).</li>
                <li>Signal Preprocessing Techniques – Covers noise removal, filtering, and artifact reduction to improve signal clarity and accuracy.</li>
                <li>Feature Extraction – Discusses methods to identify key characteristics like heart rate variability in ECG and brain wave patterns in EEG.</li>
                <li>Time and Frequency Domain Analysis – Explores analytical tools such as FFT, wavelet transforms, and spectral analysis for signal interpretation.</li>
                <li class="hidden" id="more-features">
                 Pattern Recognition and Classification – Introduces machine learning approaches for disease detection and diagnosis.<br>
                 Clinical Applications – Demonstrates real-world uses in cardiac monitoring, neurological assessment, and medical device development.<br>
                ...
                Automation and AI Integration – Highlights the role of AI and deep learning in automated biomedical diagnostics.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="biomedical-signal-processing-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-teal-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>276</li>
