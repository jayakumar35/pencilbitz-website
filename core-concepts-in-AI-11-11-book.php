...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Core Concepts in AI | Pencil Bitz Book</title>
        ...
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="" class="hover:underline text-blue-600 flex items-center">
<i class="fa-solid fa-book-open-reader mr-1"></i>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/core-concepts-in-AI-11-11-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/core-concepts-in-AI-11-11-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/core-concepts-in-AI-11-11-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2"> Core Concepts in AI </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="#">Prof. Gunwant Deoman Rahane
                                <br>Prof. Vikas N. Nimbalkar
                                <br>Prof. Manohar C. Chavan
                            </li>
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-55-8 | 2025 </span></div>
                            </li>
                        </ul>
          ...
          class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Dr. David Raj - JPG</a> -->
                    ...
                    <a href="/core-concepts-in-AI-11-11-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        ...
                        Core concepts in AI include perception, reasoning, learning, and decision-making to simulate intelligent behavior. Machine learning enables data-driven improvements through supervised, unsupervised, and reinforcement methods. Neural networks, especially deep learning, model complex patterns via layered representations and backpropagation. Ethical considerations—bias, transparency, safety, and governance—guide responsible AI deployment across diverse applications.
                    </p>
                </div>
