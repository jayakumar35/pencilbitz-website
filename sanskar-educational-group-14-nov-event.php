    ...
    <div style="max-width: 1520px;" class="relative container ">
        <div class="container-event overflow-hidden py-5">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                ...
                <img src="assets/img/upcomeing-event/sanskar-nov-14-event.jpg" alt="Event Image" class="img-fluid rounded-4 shadow-lg border border-0 rounded-2" style="max-height: 600px; object-fit: cover;">
                </div>
            </div>
            <!-- Event Details -->
            <div class="col-lg-6 col-md-12">
                ...
                <ul class="list-unstyled mb-4 ps-3 ">
                    <li class="mb-2"><i class="fas fa-calendar-alt text-primary me-2"></i> <strong>Date:</strong> 14 November 2025</li>
                    <li class="mb-2"><i class="fas fa-clock text-primary me-2"></i> <strong>Time:</strong> 7:00PM To 9:00PM </li>

                    <li class="mb-2"><i class="fas fa-map-marker-alt text-primary me-2"></i> <strong>Location:</strong>Parson, Uttar Pradesh</li>
                    <li class="mb-2"><i class="fas fa-user-tie text-primary me-2"></i> <strong>Speaker:</strong> +91 77088 28673</li>
                </ul>
                <a href="https://forms.gle/1tXDdHKiVTcTyd4o7" class="bg-gray-200 hover:bg-green-300 hover:text-gray-800 rounded-2 text-gray-800 shadow-lg fw-bold px-4 py-2">
