...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="ai-in-robotics-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/ai-in-robotics-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/ai-in-robotics-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/ai-in-robotics-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-yellow-700 mb-2">AI in Robotics</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="">R.Bhuvaneswari <br> R.Tamilselvi  <br> P.Abinaya  <br> R.Bhuvaneswari</li>
                            <li>
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Artificial Intelligence (AI) empowers robots with the ability to learn, adapt, and make decisions.</li>
                            <li>AI-driven robotics goes beyond pre-programmed tasks by enabling autonomous behavior</li>
                            <li>Machine learning helps robots improve performance through experience and data analysis.</li>
                            <li>Computer vision allows robots to perceive, recognize, and interpret their surroundings.</li>
                            <li class="hidden" id="more-features">
                              Natural language processing enables robots to understand and communicate with humans.<br>
                             AI in robotics enhances automation in industries like manufacturing, healthcare, and logistics.<br>
                              Collaborative robots (cobots) work safely alongside humans, improving productivity.<br>
                             AI-powered robots are used in self-driving vehicles, drones, and smart home devices.<br>
                              Ethical concerns include job displacement, safety, and responsible decision-making.
                              The future of AI in robotics aims at creating intelligent, adaptive, and human-friendly machines.
                            </li>
                        </ul>
                    ...
                    <a href="ai-in-robotics-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-700 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 215</li>
