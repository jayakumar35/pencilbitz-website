  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3">
      ...
      <li class="flex items-center">
        ...
        Deep Learning for Business Analytics Beginner's Handbook
        </span>
      </li>
      </ol>
    </nav>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Deep Learning for Business Analytics Beginner s Handbook-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-blue-700');
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Deep Learning for Business Analytics Beginner s Handbook-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/Deep Learning for Business Analytics Beginner s Handbook-p3.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          ...
          <img
        src="assets/img/new/book-page/Deep Learning for Business Analytics Beginner s Handbook-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        ...
        <ul class="list-disc list-inside text-gray-700 text-center sm:text-left">
            <li class="">Dr.D. Ravindran <br> Dr. Vinothina V <br> Dr. Chandrakhanthan J <br> Dr. Jisha V G</li>
        ...
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                ...
                <li>Detailed explanation of neural networks, backpropagation, and activation functions.</li>
                <li>Coverage of convolutional and recurrent neural networks with practical examples.</li>
                <li>Emphasis on real-world applications in image, speech, and natural language processing.</li>
                <li class="hidden" id="more-features">
                    Hands-on projects and Python code samples for essential algorithms.<br>
                    Discussion of optimization techniques and regularization methods.<br>
                    Real-world case studies for practical understanding.<br>
                    Suitable for students, educators, and professionals in AI and data science.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="Deep-Learning-for-Business-Analytics-Beginner-Handbook-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-700 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span> 336</li>
