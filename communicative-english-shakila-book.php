...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="communicative-english-shakila-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/communicative-english-shakila-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-fuchsia-500');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-fuchsia-500');
          this.classList.add('border-gray-600');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/communicative-english-shakila-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/communicative-english-shakila-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                ...
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-fuchsia-500 mb-2">Communicative English</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Mrs. K.Shakila Banu</li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-993118-0-0| 2025 |</span></div>
                            </li>
                        </ul>
                        <div class="flex flex-wrap gap-4 items-center mt-3">
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div class="flex gap-4">
                                            <div id="author1" class="hidden flex gap-4 flex-wrap">
                                                <a href="assets/img/books-certificate/Communicative English a1.pdf" download
                                                    class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Mrs. K.Shakila Banu - PDF</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", () => {
                                    ...
                                    const correctNumber = "9940811683"; // ✅ your correct phone number
                    ...
                    <a href="communicative-english-shakila-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-fuchsia-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2">
                       Fundamentals of Antenna Theory and Design explores the principles behind antenna operation, including radiation mechanisms, parameters, and patterns. It covers antenna types such as dipole, loop, and array antennas, along with impedance matching and efficiency. The subject emphasizes practical design techniques for wireless communication, radar, and satellite systems.
                    </p>
                </div>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4 ps-5">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-fuchsia-500 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
