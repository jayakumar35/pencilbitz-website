...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="intelligent-systems-book.php" class="hover:underline text-blue-600 flex items-center">
      <i class="fas fa-microscope mr-1"></i>
      <i class="fas fa-heartbeat mr-1"></i>
     Intelligent Systems Ai Fundamentals And Applications
      </a>
      <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
    </li>
    </ol>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/intelligent-systems-ai-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-teal-700');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-teal-700');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/intelligent-systems-ai-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/intelligent-systems-ai-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          <img
        src="assets/img/new/book-page/intelligent-systems-ai-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-teal-700 mb-2">Intelligent Systems Ai Fundamentals And Applications<h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr.D.Muruganandam <br>  Dr.J.Jayapriya <br>Ryan A Pins</li>
              <li> <br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-48-6| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
            ...
            <li>Autonomy – Can perform tasks without constant human intervention.</li>
            <li>Learning Ability – Learns from data using machine learning algorithms.</li>
            <li> Perception – Uses sensors or data input to understand the environment.</li>
            <li>Adaptability – Adjusts behavior based on new inputs or situations.</li>
            <li class="hidden" id="more-features">
              Natural Language Processing (NLP) – Understands and responds in human language.<br>
              Problem Solving – Analyzes situations and finds optimal solutions.<br>
             Automation – Automates complex or repetitive tasks efficiently<br>
              Data-Driven Decisions – Uses data to make smart and accurate decisions.<br>
             Human-AI Interaction – Interacts with users through interfaces like chatbots or robots.
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="intelligent-systems-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-teal-700 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-teal-800">
