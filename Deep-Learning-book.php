...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="Deep-Learning-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Deep Learning-p2.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Deep Learning-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-blue-400 mb-2">Deep Learning</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase text-justify text-sm sm:text-base">M.A. Reetha Jeyarani <br> R. Roshan Joshua</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-49-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Comprehensive introduction to deep learning concepts and architectures.</li>
                <li>Explains neural networks, backpropagation, and activation functions in detail.</li>
                <li>Covers convolutional and recurrent neural networks with practical examples.</li>
                <li>Focus on real-world applications in image, speech, and natural language processing.</li>
                <li class="hidden" id="more-features">
                    Includes hands-on projects and Python code samples for key algorithms.<br>
                    Discusses optimization techniques and regularization methods.<br>
                    Real-world case studies for practical understanding.<br>
                    Useful for students, educators, and professionals in AI and data science.<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="Deep-Learning-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-blue-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Binding:</span> Hardcover</li>
            <li><span class="font-semibold">Pages:</span> 148</li>
