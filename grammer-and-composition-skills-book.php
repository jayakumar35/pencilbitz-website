...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="grammer-and-composition-skills-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/grammer-and-composition-skill-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/grammer-and-composition-skill-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/grammer-and-composition-skill-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                ...
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-pink-500 mb-2">Grammar and Composition Skills for Success</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Dr.D.Jones Sudha </li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-992599-6-6| 2025 |</span></div>
                            </li>
                        </ul>
                        <div class="flex flex-wrap gap-4 items-center mt-3">
                            ...
                            <!-- Popup Modal -->
                            <div id="certificatePopup" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div class="flex gap-4">
                                            <div id="author1" class="hidden flex gap-4 flex-wrap">
                                                <a href="assets/img/books-certificate/Grammar and Composition Skills for Success a1.pdf" download
                                                    class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.D.Jones Sudha - PDF</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", () => {
                                    ...
                                    const correctNumber = "9486707125"; // ✅ your correct phone number
                    ...
                    <a href="grammer-and-composition-skills-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-pink-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2">
                       Grammar and composition skills are essential for effective communication in both academic and professional settings. Grammar provides the foundation for constructing clear, correct sentences, covering aspects such as parts of speech, punctuation, sentence structure, and verb tense consistency. Composition skills involve organizing ideas logically, developing coherent paragraphs, and expressing thoughts with clarity and precision. Mastery of these skills enhances writing fluency, improves comprehension, and strengthens the ability to convey ideas persuasively. Effective grammar and composition promote confidence in writing reports, essays, and correspondence, ultimately contributing to personal, educational, and career success in today’s communication-driven world.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>225</li>
                        <li><span class="font-semibold">Dimensions:</span> 24 x 18 x 1.5 cm</li>
                        <li><span class="font-semibold">Weight:</span> 420g</li>
                    </ul>
                </div>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4 ps-5">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-pink-500 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
