    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="deep-learning-techniques-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/deep-learning-techniques-p1.png"
          ...
          this.classList.add('border-amber-800');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/deep-learning-techniques-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-amber-800 mb-2">Deep Learning Techniques</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Dr. Swetta Kukreja <br> Dr. Deepa Parasar</li>
                            <li><br>
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Deep learning is a branch of machine learning that uses neural networks with many layers to learn from data.</li>
                            <li>It works well with large datasets and complex problems like image recognition, speech, and natural language processing.</li>
                            <li>Convolutional Neural Networks (CNNs) are used mainly for image and video processing.</li>
                            <li>Recurrent Neural Networks (RNNs) are designed for sequential data, like text and speech.</li>
                            <li class="hidden" id="more-features">
                              Long Short-Term Memory (LSTM) networks solve the problem of remembering long-term dependencies in sequences.<br>
                              Generative Adversarial Networks (GANs) are used to generate new data, like images or music.<br>
                              Autoencoders are used for dimensionality reduction and anomaly detection.<br>
                             Deep Reinforcement Learning combines deep learning with decision-making to train systems like game-playing AI.
                            </li>
                        </ul>
                    ...
                    <a href="deep-learning-techniques-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-amber-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 153</li>
