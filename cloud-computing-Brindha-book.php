...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="cloud-computing-Brindha-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/cloud-computing-brindha-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-violet-400');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-violet-400');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/cloud-computing-brindha-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/cloud-computing-brindha-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-violet-400 mb-2">Cloud Computing</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="">Dr.S. Brindha  <br> Dr. D. Suresh</li>
                            <li>
                    ...
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Cloud computing is the delivery of computing services—like storage, servers, databases, and software—over the internet.</li>
                            <li>Instead of owning physical hardware, users access resources on demand from cloud providers.</li>
                            <li>Cloud computing offers scalability, letting businesses increase or decrease resources as needed.</li>
                            <li>It provides high availability and reliability, with minimal downtime.</li>
                            <li class="hidden" id="more-features">
                              Major service models include IaaS (Infrastructure as a Service), PaaS (Platform as a Service), and SaaS (Software as a Service).<br>
                              Deployment models include Public, Private, Hybrid, and Community clouds.<br>
                              Cloud enhances collaboration by allowing multiple users to work on the same system from anywhere<br>
                    ...
                    <a href="cloud-computing-Brindha-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-violet-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
