...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="Fundamentals-of-web-technology-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Fundamentals Of Web Technology-p1.png"
        ...
        onclick="
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-cyan-800');
            img.classList.add('border-gray-200');
          });
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-cyan-800');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Fundamentals Of Web Technology-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-cyan-800 mb-2">Fundamentals Of Web Technology</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li> SELVAMANJU E <br> LEKHAA V <br> DEEPTHI V</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-81-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          ...
          <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
            <li>Platform Independent: Runs on any device or OS with a browser and internet connection.</li>
            <li>Global Accessibility: Accessible from anywhere via a URL.</li>
            <li>Dynamic & Interactive: Supports rich user experiences using HTML, CSS, and JavaScript.</li>
            <li>Scalable: Easily handles more users and data with modern frameworks and cloud infrastructure.</li>
            <li>Cross-Browser Compatibility: Works seamlessly across Chrome, Firefox, Safari, Edge, and more.</li>
            <li>Integration Ready: Connects with databases, APIs, cloud services, and third-party platforms.</li>
            <li class="hidden" id="more-features">
              <ul class="list-disc list-inside ">
                <li>Responsive Design: Adapts to desktops, tablets, and mobile devices.</li>
                <li>Secure: Implements modern security standards and protocols.</li>
                <li>Easy Maintenance: Updates and bug fixes can be deployed instantly.</li>
                <li>Cost Effective: Reduces deployment and distribution costs.</li>
              </ul>
            </li>
          </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹1688 </span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹1768</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="Fundamentals-of-web-technology-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-cyan-800 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-500">
