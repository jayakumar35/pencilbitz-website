        ...
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="probability-and-statistics-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="list-disc list-inside text-gray-700">
                            <li class=""> Dr. Gautham Goud Ravula
                                <br>Dr. Ameen Saheb Shaik
                                <br>Dr.B.Vittal
                                <br>Mr.R.Ashok
                            </li>
                            <br>
              ...
              <a href="https://www.amazon.in/dp/819922309X" target="_blank"
                ...
                <span>Amazon</span>
                    ...
                    <a href="probability-and-queueing-theory-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800">Probability and Queuing Theory studies random events and waiting line behavior. Probability deals with predicting uncertain outcomes using mathematical models. Queuing theory analyzes systems with queues to optimize service efficiency, reduce waiting times, and improve resource utilization. Both are essential in operations research, telecommunications, and performance analysis of networks and systems.
                    </p>
                </div>
