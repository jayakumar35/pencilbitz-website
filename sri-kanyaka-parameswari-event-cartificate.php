    ...
    <script>
        lucide.createIcons();
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0 ">
                ...
                <img src="assets/img/upcomeing-event/sri-kanyaka-.jpg" alt="Event Image" class="img-fluid rounded-4 shadow-lg border border-0 rounded-2" style="max-height: 600px; object-fit: cover;">
                </div>
            </div>
            <!-- Event Details -->
            <div class="col-lg-6 col-md-12">
                <div class="event-content px-2">
                    ...
                    <h1 class="font-semibold text-gray-700 text-3xl py-2 ps-3">
                     SRI KANYAKA PARAMESWARI ARTS&SCIENCE COLLEGE FOR WOMEN </span>
                   </h1>
                </div>
                <h3 class="fw-medium fs-3 text-gray-500  ">Topic</h3>
                <h1 class="fw-semibold fs-2 text-red-500 mb-3 ps-3">Role of Architecture in Inteterior Design</h1>
