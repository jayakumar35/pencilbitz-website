...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title>Mastering Deep Learning Architecture | Pencil Bitz Book</title>
    ...
    <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
            src="assets/img/new/book-page/mastering-deep-learning-swarna-p1.png"
        ...
        "
            alt="Thumbnail 1">
          <img
            src="assets/img/new/book-page/mastering-deep-learning-swarna-p2.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            alt="Thumbnail 2">
          <img
            src="assets/img/new/book-page/mastering-deep-learning-swarna-p3.png"
            class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
            style="image-rendering: auto;"
            onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-red-900 mb-2">Mastering Deep Learning Architecture</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li class="uppercase">Dr. SWARNA SUREKHA</li>
              <li>
                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-992599-0-4| 2025 |</span></div>
              </li>
            </ul>
                ...
                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                  ...
                  <div id="downloadSection" class="mt-5 hidden">
                    ...
                    <div id="author1" class="hidden flex gap-4 flex-wrap">
                      <a href="assets/img/books-certificate/Mastering Deep Learning Architecture a1.pdf" download
                        class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr. SWARNA SUREKHA - PDF</a>
                    </div>
          ...
          <a href="mastering-deep-learning-swarna-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <p class="text-gray-700 leading-relaxed p-2">
            <span class="font-medium text-gray-800">Mastering deep learning architecture involves designing and evaluating neural networks that efficiently learn representations, optimize performance, and generalize well across tasks. It encompasses choosing appropriate layers, connectivity patterns, and training strategies to build scalable and robust models.          </p>
        </div>
