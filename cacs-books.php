...
<body class="bg-gray-100">
  ...
  <div class="row mx-auto w-full">
    <nav class="mb-6 rounded-lg px-4 py-3 w-full">
      <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
        ...
        <li class="flex items-center">
          <a href="cacs-books.php" class="hover:underline text-blue-600 flex items-center">
            <i class="fas fa-shield-alt mr-1"></i> Cryptography and Cyber Security
          </a>
          <span class="mx-2 text-gray-400"><i class="fas fa-chevron-right"></i></span>
        </li>
      </ol>
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Cryptography and Cyber Security-p1.png"
        ...
        onclick="
          ...
          this.classList.add('border-fuchsia-500');
        "
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Cryptography and Cyber Security-np2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-pink-600 mb-2">Cryptography and Cyber Security</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
              <li>DR.CHANDR MOLI VENKATSRINIVAS AKANA | DR.CHAYA KUMARI DIVAKARLA</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-61-5| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            ...
            <li>Ensures only authorized people can read the information (Confidentiality).</li>
            <li>Protects data from unauthorized changes (Integrity).</li>
            <li>Verifies the identity of users or devices (Authentication).</li>
            <li>Prevents denial of actions or transactions (Non-repudiation).</li>
            <li>Uses modern encryption techniques (e.g., AES, RSA) and hash functions (e.g., SHA-256).</li>
            <li class="hidden" id="more-features">
              <ul class="list-disc list-inside ">
              <li>Explains digital signatures, certificates, and password mechanisms.</li>
              <li>Real-world examples and case studies for better understanding.</li>
              <li>Coverage of both classical and modern cryptography.</li>
              <li>Focus on cyber security principles and best practices.</li>
              <li>Includes review questions and practical exercises.</li>
              </ul>
            </li>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="cacs-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-pink-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-purple-700">
