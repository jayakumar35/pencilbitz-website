...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="basic-electrical-engineering-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-p1.png"
          ...
          thumbs.forEach(function(img) {
            img.classList.remove('border-yellow-700');
            img.classList.add('border-gray-200');
          });    
          // Add highlight to clicked thumbnail
          this.classList.remove('border-gray-200');
          this.classList.add('border-yellow-700');
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/basic-electrical-engineering-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-yellow-700 mb-2">Basic Electrical Engineering</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Dr.Nidhi Mishra  <br>  Prof.Dipanjali Padhi <br>
                             Prof.ChetanaS.Kelkar</li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-32-5 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Basic Electrical Engineering deals with the study of electricity, circuits, and electrical devices.</li>
                            <li>It covers fundamental concepts such as voltage, current, resistance, and power.</li>
                            <li>Ohm’s Law establishes the relationship between voltage, current, and resistance.</li>
                            <li>Electrical circuits are classified as series, parallel, or combination networks.</li>
                            <li class="hidden" id="more-features">
                             Alternating Current (AC) and Direct Current (DC) are the two main types of electrical supply.<br>
                            Generators and motors convert energy between electrical and mechanical forms.<br>
                             Electrical measuring instruments like voltmeters and ammeters are used for analysis.<br>
                             Safety measures and grounding are essential to prevent electrical hazards.<br>
                            Basic Electrical Engineering forms the foundation for advanced studies in electronics and power systems.
                            </li>
                        </ul>
                    ...
                    <a href="basic-electrical-engineering-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-700 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-yellow-700 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
