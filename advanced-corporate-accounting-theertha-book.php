...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="advanced-corporate-accounting-theertha-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/advanced-corporate-accounting-theertha-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/advanced-corporate-accounting-theertha-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/advanced-corporate-accounting-theertha-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-orange-500 mb-2">Advance Corporate Accounting </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Mr.Theertha Prasad K </li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-991695-8-6| 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Corporate Restructuring – Covers mergers, amalgamations, absorptions, and reconstructions of companies.</li>
                            <li>Consolidated Financial Statements – Focuses on preparing accounts for holding and subsidiary companies.</li>
                            <li>Valuation Techniques – Explains methods for valuing goodwill, shares, and business combinations.</li>
                            <li>Accounting for Liquidation – Deals with procedures for preparing statements of affairs and deficiency accounts.</li>
                            <li class="hidden" id="more-features">
                             Amalgamation and Absorption – Demonstrates journal entries and balance sheet treatments as per accounting standards. <br>
                             Compliance with Accounting Standards – Emphasizes IFRS, AS, and Ind AS for transparent financial reporting.<br>
                              Corporate Governance and Disclosure – Highlights ethical reporting, stakeholder communication, and regulatory compliance.<br>
                            </li>
                        </ul>
                        </ul>
                    ...
                    <a href="advanced-corporate-accounting-theertha-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
