...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/business-analytics-sharathchandra-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/business-analytics-sharathchandra-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/business-analytics-sharathchandra-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-pink-500 mb-2">  Business Analytics </h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase"> Mr. Sharathchandra Kamath K <br>  Mr. Subhash Kumar K <br>  Mrs.VK Durgadevi </li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-38-7| 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Business Analytics is the practice of using data, statistical methods, and models to make better business decisions.</li>
                            <li>It involves collecting, cleaning, and analyzing data to gain useful insights.</li>
                            <li>There are three main types: descriptive (what happened), predictive (what will happen), and prescriptive (what should be done).</li>
                            <li class="hidden" id="more-features">
                              Tools like Excel, Python, R, SQL, Power BI, and Tableau are commonly used.<br>
                               Data visualization helps present findings clearly for decision-makers.<br>
                               Predictive models use machine learning and statistical techniques to forecast trends.<br>
                                Prescriptive analytics suggests optimal actions to improve outcomes.<br>
                              It improves efficiency, reduces risks, and supports strategic planning.
                            </li>
                        </ul>
                    ...
                    <a href="business-analytics-sharathchandra-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-pink-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
