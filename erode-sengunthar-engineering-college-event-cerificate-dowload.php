                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mb-6 lg:mb-0">
                        <div class="d-flex justify-content-center align-items-center h-auto">
                            <img src="assets/img/upcomeing-event/erode-sengunthar-02-nov-event.jpg" alt="Event Image" class="w-full max-h-[700px] object-cover rounded-xl shadow-xl transition-transform duration-500 hover:scale-[1.01]">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="event-content px-2">
                            ...
                            <h1 class="font-extrabold text-4xl text-gray-800 leading-tight mb-4 border-l-4 border-red-500 pl-3">
                                EROAD SENGUNTHAR ENGINEERING COLLEGE
                            </h1>
                            <h3 class="text-lg font-bold text-gray-500 tracking-wider uppercase mb-1">Titel</h3>
                            <h2 class="text-2xl font-semibold text-red-600 mb-6 pl-3">AI Tools For Education</h2>
                            ...
                            <ul class="space-y-4 mb-8 text-gray-700 font-medium">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Date:</strong> 02 November 2025
                                    </div>
                                </li>
                                <li class="flex items-start">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        <strong class="text-gray-800">Location:</strong> Perundurai, Tamil Nadu
                                    </div>
                                </li>
                                <li class="flex items-start">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="https://forms.gle/xWcSeZGXs4jqhfZh7" class="register-button inline-flex items-center justify-center bg-red-600 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-red-700 transition-colors duration-300 transform hover:scale-[1.02]">
                                    Register Now <i class="fas fa-arrow-right ml-2"></i>
                                </a>
                                <a href="assets/img/event-certificate/Erode-Certificates.pdf" class="register-button inline-flex items-center justify-center bg-sky-500 text-white font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-sky-600 transition-colors duration-300" download="">
