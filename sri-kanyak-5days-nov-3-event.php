            ...
            <div class="col-lg-6 col-md-12">
                <div class="event-content px-2">
                    ...
                    <h1 class="font-semibold text-gray-700 text-3xl py-2 ps-3">
                     SRI KANYAKA PARAMESWARI ARIS & SCIENCE COLLEGE FOR WOMEN</span>
                   </h1>
                </div>
                <h3 class="fw-medium fs-3 text-gray-500  ">Topic</h3>
                <h1 class="fw-semibold fs-2 text-red-500 mb-3 ps-3">Role Of Architecture in Interior Design</h1>
                <h3 class="fw-medium fs-3 text-gray-500 ">Details</h3>

                <ul class="list-unstyled mb-4 ps-3 ">
                    <li class="mb-2"><i class="fas fa-calendar-alt text-primary me-2"></i> <strong>Date:</strong> 03 to 07 November 2025</li>
                ...
                <a href="https://forms.gle/5PBjLisVxwUY4adT9" class="bg-gray-200 hover:bg-green-300 hover:text-gray-800 rounded-2 text-gray-800 shadow-lg fw-bold px-4 py-2">
