...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="advance-corporate-accounting-vanitha-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/advance-corporate-accounting-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/advance-corporate-accounting-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/advance-corporate-accounting-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-yellow-500 mb-2">Advance Corporate Accounting</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Dr.A.Vanitha  | Dr.P.Sri Padma Abirami  | Ms.S.Sruthi</li>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-78-3 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Advance Corporate Accounting deals with complex accounting practices beyond basic financial accounting.</li>
                            <li>It focuses on company-level transactions such as amalgamations, absorptions, and reconstructions.</li>
                            <li>Preparation and presentation of consolidated financial statements for holding and subsidiary companies are key areas.</li>
                            <li>It covers accounting for share capital, debentures, and redemption processes.</li>
                            <li class="hidden" id="more-features">
                              Valuation of goodwill and shares forms an important aspect of decision-making.<br>
                              Banking company and insurance company accounts are prepared under special legal requirements.<br>
                              It includes liquidation accounting, where assets and liabilities are settled during company closure.<br>
                              International Financial Reporting Standards (IFRS) and Indian Accounting Standards (Ind AS) guide corporate disclosures.
                              The subject emphasizes transparency, accuracy, and compliance with corporate laws. It equips students with knowledge for handling financial complexities in large organizations.
                              Would you like me to also create a 150-word summary for more detail, similar to your other subject notes?
                            </li>
                        </ul>
                    ...
                    <a href="advance-corporate-accounting-vanitha-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-yellow-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span>5 Units</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="https://www.instagram.com/pencilbitz" target="_blank" class="text-sky-800 text-2xl" title="Instagram"><i class="fab fa-instagram"></i></a>
