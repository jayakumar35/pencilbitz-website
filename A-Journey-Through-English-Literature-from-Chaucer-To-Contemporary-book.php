...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title> A Journey Through English Literature:from Chaucer To Contemporary | Pencil Bitz Books</title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="/A-Journey-Through-English-Literature-from-Chaucer-To-Contemporary-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/A-Journey-Through-English-Literature-from-Chaucer-To-Contemporary-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/A-Journey-Through-English-Literature-from-Chaucer-To-Contemporary-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/A-Journey-Through-English-Literature-from-Chaucer-To-Contemporary-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-blue-900 mb-2">A Journey Through English Literature:from Chaucer To Contemporary</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class=""> Dr. Mythili b
                                <br>Dr.N.Sumathi
                                <br>Dr.S.Revathi
                                <br>Prof. Adisha Manna
                            </li>
                            <br>
                            <li>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-81-993118-9-3| 2025</span></div>
                            </li>
                        </ul>
                ...
                <!-- Flipkart -->
              <a href="https://www.flipkart.com/journey-through-english-literature-from-chaucer-contemporary-1-disc/p/itmd5744eadc47d6?pid=9788199311893" target="_blank"
              ...
              <!-- Amazon -->
              <a href="https://www.amazon.in/dp/8199311894" target="_blank"
                ...
                <span>Amazon</span>
                                ...
                                <div class="bg-white p-6 rounded-2xl shadow w-full max-w-md relative">
                                    ...
                                    <div id="downloadSection" class="mt-5 hidden">
                                        ...
                                        <div id="author1" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/A JOURNEY THROUGH ENGLISH LITERATUREFROM CHAUCER TO CONTEMPORARY a1.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr. Mythili b- PDF</a>
                                        </div>

                                        <!-- Author 2 -->
                                        <div id="author2" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/A JOURNEY THROUGH ENGLISH LITERATUREFROM CHAUCER TO CONTEMPORARY a2.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.N.Sumathi- PDF</a>
                                        </div>

                                        <!-- Author 3 -->
                                        <div id="author3" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/A JOURNEY THROUGH ENGLISH LITERATUREFROM CHAUCER TO CONTEMPORARY a3.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Dr.S.Revathi- PDF</a>
                                        </div>

                                        <!-- Author 4 -->
                                        <div id="author4" class="hidden flex gap-4 flex-wrap">
                                            <a href="assets/img/books-certificate/A JOURNEY THROUGH ENGLISH LITERATUREFROM CHAUCER TO CONTEMPORARY a4.pdf" download
                                                class="px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700">Prof. Adisha Manna- PDF</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="/A-Journey-Through-English-Literature-from-Chaucer-To-Contemporary-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify">
                        <span class="font-medium text-gray-800"> English literature has evolved across centuries, reflecting cultural, social, and intellectual transformations. From Chaucer’s medieval narratives to modern experimental works, each era contributes unique styles and themes. This journey highlights the development of language, storytelling, and literary expression. It offers insight into changing human experiences and the enduring power of literature.
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 220</li>
