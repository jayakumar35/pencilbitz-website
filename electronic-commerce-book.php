...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title> Electronic Commerce | Pencil Bitz Book</title>
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="electronic-commerce-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/electronic-commerce-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/electronic-commerce-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/electronic-commerce-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-emerald-500 mb-2"> Electronic Commerce</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="">Dr.S.Ramamurthy <br> Dr Ashok kumar T <br> Dr Priya S</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-76-9| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Online Buying and Selling – Facilitates the exchange of goods and services over the internet through digital platforms.</li>
                <li>Business Models – Includes B2B, B2C, C2C, and C2B models catering to different market segments.</li>
                <li>Digital Payment Systems – Uses secure payment gateways, mobile wallets, and cryptocurrency for seamless transactions.</li>
                <li>E-Marketing and Personalization – Employs SEO, social media, and data analytics to target customers effectively.</li>
                <li class="hidden" id="more-features">
            Supply Chain and Logistics Integration – Enhances efficiency through real-time tracking and automated inventory management.<br>
              Security and Privacy – Focuses on encryption, authentication, and data protection for safe online interactions.<br>
              Global Reach and Scalability – Enables businesses to operate across borders, expanding customer access and market potential.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="electronic-commerce-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-emerald-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>163</li>
