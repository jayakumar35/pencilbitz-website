...
<head>
    ...
    <script>
        ...
        function copyUPI(upiIdElementId, copyBtnElementId) {
            const upiId = document.getElementById(upiIdElementId).innerText;
            navigator.clipboard.writeText(upiId).then(() => {
                const copyBtn = document.getElementById(copyBtnElementId);
...
<body class="bg-gray-50 font-sans min-h-screen flex items-center justify-center p-2 sm:p-6">
    <div class="max-w-7xl mx-auto w-full">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-8 mt-4">Client Payment Links</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden border border-gray-100 p-6 flex flex-col items-center">
                <div class="bg-pencilbitz-light rounded-xl p-4 w-full flex flex-col items-center mb-6">
                    <img src="assets/img/new-logo-pencilbitz.jpg" alt="Pencil Bitz Logo" class="w-16 h-16 object-contain mb-2 rounded-full border border-green-500 shadow">
                    <h1 class="text-xl font-bold text-gray-800">Pencil Bitz Publications</h1>
                    <p class="text-gray-600 text-sm mt-1">Text Book Publications Payment Link</p>
                </div>
                <div class="qr-container p-6 rounded-xl flex flex-col items-center mb-6 w-full">
                    <div class="w-48 h-48 bg-white rounded-xl flex items-center justify-center shadow-hard mb-4">
                        <img src="assets/img/payment.jpg" alt="UPI QR Code" class="w-full h-full object-contain rounded-lg p-1">
                    </div>
                    <div class="text-center w-full mb-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Sangeetha Subramaniam</h3>
                        <div class="flex upi-container items-center justify-center">
                            <div class="bg-white bg-opacity-20 rounded-lg px-4 py-2 upi-id flex-grow">
                                <p id="upi-id-1" class="text-gray-800 font-medium text-sm sm:text-base truncate">sangeethasubramaniam.pb@okaxis</p>
                            </div>
                    ...
                    <div class="w-full">
                        <h4 class="text-gray-800 font-semibold mb-2 text-center text-sm uppercase tracking-wider">
                            <i class="fas fa-mobile-alt mr-2"></i> Accepts Payments
                        </h4>
                        <div class="grid grid-cols-3 gap-3">
                            <div class="app-logo-container flex items-center justify-center">
                                <img src="assets/img/gpay.webp" alt="Google Pay" class="h-10 w-auto object-contain">
                            </div>
                            <div class="app-logo-container flex items-center justify-center">
                                <img src="assets/img/phonepe-new.png" alt="PhonePe" class="h-10 w-auto object-contain">
                            </div>
                            <div class="app-logo-container flex items-center justify-center">
                                <img src="assets/img/paytm.png" alt="Paytm" class="h-10 w-auto object-contain">
                            </div>
                        </div>
                    </div>
                </div>

                <div class="bg-pencilbitz-light rounded-xl p-4 w-full border border-gray-200 shadow-inner">
                    <h3 class="text-pencilbitz-dark font-semibold mb-3 flex items-center text-base">
                        <i class="fas fa-id-card mr-2 text-pencilbitz-primary"></i> Account Information
                    </h3>
                    <ul class="space-y-2 text-sm text-gray-800">
                        <li><strong>Account Holder:</strong> PARVESHMUZARAF R</li>
                        <li><strong>Account Number:</strong> 1150155000171459</li>
                        <li><strong>Account IFSC:</strong> KVBL0001150</li>
                        <li><strong>Account Branch:</strong> KULITHALAI</li>
            ...
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden border border-gray-100 p-6 flex flex-col items-center">
                ...
                <div class="qr-container p-6 rounded-xl flex flex-col items-center mb-6 w-full">
                    <div class="w-48 h-48 bg-white rounded-xl flex items-center justify-center shadow-hard mb-4">
                        <img src="assets/img/meni.jpg" alt="UPI QR Code" class="w-full h-full object-contain rounded-lg p-1">
                    </div>
                    <div class="text-center w-full mb-4">
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">CITRAMENI</h3>
                        <div class="flex upi-container items-center justify-center">
                            <div class="bg-white bg-opacity-20 rounded-lg px-4 py-2 upi-id flex-grow">
                                <p id="upi-id-2" class="text-gray-800 font-medium text-sm sm:text-base truncate">9943730317@axl</p>
                            </div>
                ...
                <div class="bg-pencilbitz-light rounded-xl p-4 w-full border border-gray-200 shadow-inner">
                    ...
                    <ul class="space-y-2 text-sm text-gray-800">
                        <li><strong>Account Holder:</strong> CITRAMENI</li>
                        <li><strong>Account Number:</strong> 50100805610357</li>
                        <li><strong>Account IFSC:</strong> HDFC0001588</li>
                        <li><strong>Account Branch:</strong> GANDHIPURAM</li>
                        <li><strong>Account Type:</strong> SAVING</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="bg-pencilbitz-dark px-6 py-3 text-center mt-8 rounded-b-2xl">
        ...
        <header class="text-center mb-12 pt-8">
            <div class="flex justify-center mb-4">
                <div class="relative">
                    ...
                    <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-white px-4 py-1 rounded-full shadow-md">
                        <span class="text-pencilbitz-primary font-bold">PAYMENT PORTAL</span>
                    </div>
                </div>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Pencil Bitz Publications</h1>
            <p class="text-gray-600 max-w-2xl mx-auto">Secure textbook payment portal for educational institutions and students</p>
        </header>
            ...
            <div class="payment-card bg-white rounded-2xl shadow-soft overflow-hidden border border-gray-100 card-hover">
                <div class="relative">
                    <div class="gradient-bg py-6 px-8 flex flex-col items-center">
                        <div class="payment-badge bg-pencilbitz-accent text-white px-4 py-1 rounded-full font-bold text-sm">
                            Payment Link #1
                        </div>
                        <h2 class="text-xl font-bold text-white mb-4">Sangeetha Subramaniam</h2>
                        ...
                        <div class="text-center w-full mb-6">
                            <div class="flex flex-col sm:flex-row items-center justify-center">
                                <div class="bg-white bg-opacity-90 rounded-lg px-4 py-3 mb-3 sm:mb-0 sm:mr-3 w-full max-w-xs">
                                    <p id="upi-id-1" class="text-gray-800 font-bold text-lg truncate">sangeethasubramaniam.pb@okaxis</p>
                                </div>
                                <button id="copy-btn-1" onclick="copyUPI('upi-id-1', 'copy-btn-1')"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex justify-center space-x-4">
                                <div class="bg-gray-100 p-3 rounded-xl">
                                    <img src="assets/img/gpay.webp" alt="Google Pay" class="h-8 object-contain">
                                </div>
                                <div class="bg-gray-100 p-3 rounded-xl">
                                    <img src="assets/img/phonepe-new.png" alt="PhonePe" class="h-8 object-contain">
                                </div>
                                <div class="bg-gray-100 p-3 rounded-xl">
                                    <img src="assets/img/paytm.png" alt="Paytm" class="h-8 object-contain">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex flex-wrap">
                                    <div class="w-full md:w-1/2 mb-3">
                                        ...
                                        <p class="font-medium text-gray-800">PARVESHMUZARAF R</p>
                                    </div>
                                    <div class="w-full md:w-1/2 mb-3">
                                        <p class="text-gray-600 text-sm">Account Number</p>
                                        <p class="font-medium text-gray-800">1150155000171459</p>
                                    </div>
                                    <div class="w-full md:w-1/2">
                                        <p class="text-gray-600 text-sm">IFSC Code</p>
                                        <p class="font-medium text-gray-800">KVBL0001150</p>
                                    </div>
                                    <div class="w-full md:w-1/2">
                                        <p class="text-gray-600 text-sm">Branch</p>
                                        <p class="font-medium text-gray-800">KULITHALAI</p>
                                    </div>
                                </div>
