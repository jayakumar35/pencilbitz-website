...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="java-programming-unlocking-book.php" class="hover:underline text-blue-600 flex items-center">
     ...
     Java Programming: Unlocking The Power of Object-Oriented Design
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/java-programmin-unlock-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/java-programmin-unlock-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/java-programmin-unlock-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          <img
        src="assets/img/new/book-page/java-programmin-unlock-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-600 mb-2"> Java Programming: Unlocking The Power of Object-Oriented Design</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Dr.R. Krishnamoorthy <br> Mrs. K. Sathiyapriya <br> Dr. I. Godlin Atlas <br> Dr. K.V. Shiny</li>
              <li><br><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-90-5| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
            ...
            <li>Core principles: Encapsulation, Inheritance, Polymorphism, and Abstraction</li>
            <li>Encourages modular, reusable, and maintainable code</li>
            <li>Emphasizes designing blueprints using classes</li>
            <li>Objects represent real-world entities with state and behavior</li>
            <li class="hidden" id="more-features">
              Data hiding using access modifiers (private, public, protected)<br>
              Promotes control over data access and modification<br>
              Enables one class to inherit properties and methods from another<br>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="java-programming-unlocking-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-orange-800">
