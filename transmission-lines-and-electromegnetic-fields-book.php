...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg p-2 flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="transmission-lines-and-electromegnetic-fields-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/transmission-lines-and-electromegnetic-fields-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/transmission-lines-and-electromegnetic-fields-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                        alt="Thumbnail 2">
                    <img
                        src="assets/img/new/book-page/transmission-lines-and-electromegnetic-fields-p3.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-amber-600 mb-2">Transmission Lines And Electromagnetic Fields</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">Dr.Ravikiran R  <br> Prof. Shashikiran R</li>
                            <li><br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-51-6 | 2025 |</span></div>
                            </li>
                        </ul>
                    </div>
                    <!-- Book More Details -->
                    <div class="mt-3 border-t pt-2">
                        ...
                        <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                            <li>Transmission lines are used to transfer electrical energy and signals over long distances.</li>
                            <li>They are characterized by parameters such as resistance, inductance, capacitance, and conductance.</li>
                            <li>Electromagnetic fields (EMFs) govern how energy propagates along transmission lines.</li>
                            <li>The voltage and current distribution along the line are described by transmission line equations.</li>
                            <li class="hidden" id="more-features">
                            Characteristic impedance is a key factor for efficient power transfer and matching.<br>
                            Reflection and standing waves occur when there is impedance mismatch.<br>
                            The propagation constant determines signal attenuation and phase shift.<br>
                            Electromagnetic fields around transmission lines are explained using Maxwell’s equations.<br>
                            High-frequency signals require careful design to minimize loss and distortion.
                            </li>
                        </ul>
                    ...
                    <a href="transmission-lines-and-electromegnetic-fields-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-amber-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-blue-800">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700 text-sm space-y-1 mt-2 text-justify text-sm sm:text-base">
                        ...
                        <li><span class="font-semibold">Pages:</span> 266</li>
                ...
                <div class="mt-8 flex flex-col md:flex-row md:items-center gap-4">
                    <div class="flex gap-4">
                        ...
                        <a href="mailto:info@pencilbitz.com" class="text-amber-600 text-2xl" title="Email"><i class="fas fa-envelope"></i></a>
