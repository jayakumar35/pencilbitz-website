...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Quantum Computing | Pencil Bitz Book</title>
...
<body class="bg-gray-100">
    ...
    <div style="max-width: 1520px; background-image: none;" class="container my-10 ">
        <div class="row mx-auto  shadow-xl rounded-lg flex flex-col md:flex-row">
            <nav class="mb-6 bg-gray-50 rounded-lg px-4 py-3 ">
                <ol class="flex flex-wrap items-center text-gray-700 space-x-2 text-sm font-medium">
                    ...
                    <li class="flex items-center">
                        <a href="quantum-computing-10-11-book.php" class="hover:underline text-blue-600 flex items-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
                <div class="flex flex-col gap-2 mb-4">
                    <!-- Thumbnails -->
                    <img
                        src="assets/img/new/book-page/quantum-computing-10-11-p1.png"
        ...
        "
                        alt="Thumbnail 1">
                    <img
                        src="assets/img/new/book-page/quantum-computing-10-11-p2.png"
                        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
                        style="image-rendering: auto;"
                        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        "
                ...
                <img
                    id="main-book-img"
                    src="assets/img/new/book-page/quantum-computing-10-11-p3.png"
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
                <div>
                    <h2 id="book-name" class="text-3xl font-semibold text-sky-500 mb-2">Quantum Computing</h2>
                    <div class="mb-3">
                        <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
                        <ul class="list-disc list-inside text-gray-700">
                            <li class="uppercase">DR. R. KRISHNAMOORTHY
                                <br> DR. L. GODLIN ATLAS
                                <br> MRS. K. SATHIYAPRIYA
                                <br>MRS. B. BENILIN LEEBHA
                            </li>
                            <li>
                                <br>
                                <div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-89911-37-4 | 2025 </span></div>
                            </li>
                        </ul>
          ...
          class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Dr. David Raj - JPG</a> -->
                    ...
                    <a href="/quantum-computing-10-11-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-500 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
                ...
                <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
                    ...
                    <p class="text-gray-700 leading-relaxed p-2 text-justify ">
                        <span class="font-medium text-gray-800">Quantum Computing harnesses quantum phenomena such as superposition and entanglement to process information in ways classical computers cannot. Qubits, the basic units, can represent multiple states simultaneously, enabling parallel computation. Quantum algorithms, like Shor’s for factoring and Grover’s for search, offer potential speedups for certain problems. Practical challenges include maintaining coherence, error correction, and scalable qubit fabrication. The field blends physics, computer science, and engineering to develop quantum hardware and software stacks. As devices mature, quantum computing promises transformative applications in cryptography, optimization, and material science.
                    </p>
                </div>
