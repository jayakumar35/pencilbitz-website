...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="Corporate Taxation and Financial Planning-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/Corporate Taxation and Financial Planning-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/Corporate Taxation and Financial Planning-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/Corporate Taxation and Financial Planning-p3.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
          ...
          <img
        src="assets/img/new/book-page/Corporate Taxation and Financial Planning-p4.jpg"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-gray-600 mb-2">Corporate Taxation and Financial Planning</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="uppercase">Sapna Abhijeet Thakur</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-28-8| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Comprehensive coverage of corporate taxation and financial planning concepts.</li>
                <li>Detailed explanations of tax laws, compliance, and planning strategies for businesses.</li>
                <li>Includes practical case studies and real-world financial planning scenarios.</li>
                <li>Focus on recent amendments, GST, and direct/indirect tax implications.</li>
                <li class="hidden" id="more-features">
                    Covers tax computation, filing procedures, and audit requirements.<br>
                    Useful for students, professionals, and entrepreneurs.<br>
                    Authored by experienced faculty with industry insights.<br>
                    Features charts, tables, and solved examples for better understanding.<br>
                    Updated as per the latest syllabus and regulatory changes.
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="Corporate Taxation and Financial Planning-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-gray-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-sky-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span> 184</li>
