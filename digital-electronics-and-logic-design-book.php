...
<head>
  ...
  <!-- ========== Page Title ========== -->
  <title>Digital Electronics and logic Design | Pencil Bitz Book</title>
...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="digital-electronics-and-logic-design-book.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/digital-electronics-and-logic-design-p1.png"
        ...
        alt="Thumbnail 1">
          <img
        src="assets/img/new/book-page/digital-electronics-and-logic-design-p2.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
        ...
        alt="Thumbnail 2">
                  <img
        src="assets/img/new/book-page/digital-electronics-and-logic-design-p3.png"
        class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain rounded border-2 cursor-pointer bg-white border-gray-200 transition-all"
        style="image-rendering: auto;"
        onclick="
          document.getElementById('main-book-img').src=this.src;
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-orange-400 mb-2">  Digital Electronics and logic Design</h2>
          <div class="mb-3">
            <h5 class="text-lg font-semibold text-gray-700 mb-1 underline">Authors</h5>
            <ul class="list-disc list-inside text-gray-700">
                <li class="">Prof. Gopika Fattepurkar <br> Prof. Rupali Wagh <br> Dr. Vandana Navale</li>
              <li><div class="mb-2 text-gray-800">ISBN: <span class="font-mono">978-93-48556-23-3| 2025 |</span></div></li>
            </ul>
          </div>
        <!-- Book More Details -->
        <div class="mt-3 border-t pt-2">
          <h3 class="text-xl font-semibold mb-2">Key Features</h3>
            <ul class="list-disc list-inside text-gray-700 mb-2 text-md ps-3 text-justify text-sm sm:text-base">
                <li>Binary System Fundamentals – Focuses on number systems, binary arithmetic, and data representation</li>
                <li>Logic Gates and Boolean Algebra – Explains the operation of AND, OR, NOT, NAND, NOR, XOR, and XNOR gates and their simplification using Boolean laws.</li>
                <li>Combinational Circuits – Covers design and analysis of adders, multiplexers, encoders, decoders, and comparators.</li>
                <li>Sequential Circuits – Discusses flip-flops, counters, shift registers, and finite state machines.</li>
                <li class="hidden" id="more-features">
           Digital System Design – Involves circuit design using logic families and integrated circuits.    <br>
             Memory and Programmable Devices – Introduces ROM, RAM, PLD, and FPGA technologies.<br>
              Applications in Computing and Communication – Highlights the role of digital circuits in processors, embedded systems, and communication devices.<br>
                </li>
            </ul>
            </ul>
          ...
          btn.textContent = 'Read more...';
            ...
            <a href="digital-electronics-and-logic-design-order.php" class="mt-2 inline-block w-full md:w-auto text-white bg-orange-400 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-yellow-600">
        ...
        <div class="mt-6 pt-4 border border-gray-200 rounded-t-lg ps-3 shadow-md">
          ...
          <ul class="list-disc list-inside text-gray-700 text-md space-y-1 mt-2 text-justify text-sm sm:text-base">
            ...
            <li><span class="font-semibold">Pages:</span>233</li>
            <li><span class="font-semibold">Dimensions:</span> 24 x 18 x 1.5 cm</li>
            <li><span class="font-semibold">Weight:</span> 350g</li>
          </ul>
        </div>
