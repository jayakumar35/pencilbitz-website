    ...
    <div class="flex items-center justify-center min-h-screen">
        <div style="background-image: none;" class="container max-w-lg">
            <div class="bg-white shadow-xl rounded-lg p-8 flex flex-col items-center">
                <img src="assets/img/new/book-page/business-law-1-11-11-p3.png" class="w-100 h-auto rounded border-0 shadow-md mb-4" alt="Cloud Computing Book">
                <h2 id="book-name" class="text-2xl font-bold mt-2 mb-4 text-center"> Business Law </h2>
