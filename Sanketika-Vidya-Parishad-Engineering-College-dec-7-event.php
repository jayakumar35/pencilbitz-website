...
<body>
  ...
  <div style="max-width: 1520px;" class="relative container ">
    ...
    <div class="container py-5 ms-auto">
        <div class="row align-items-center">

            <!-- Event Image -->
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0 text-center">
                <img src="assets/img/upcomeing-event/Sanketika-Vidya-Parishad-Engineering-College-dec-7.jpg" 
            ...
            <div class="col-lg-6 col-md-12">
                <div class="event-content px-2 position-relative">
                    ...
                    <h1 class="text-red-500 fw-semibold mb-3">AI Tools For Startups and Entrepreneurship</h1>

                    <h3 class="text-gray-500">Details</h3>
                    <ul class="list-unstyled mb-4">
                        <li class="mb-2"><i class="fas fa-calendar-alt me-2 text-primary"></i> <strong>Date:</strong> 07 December 2025</li>
                    ...
                    <div class="d-flex justify-content-between flex-wrap gap-3">
                        <a  class="btn text-gray-800 font-semibold py-2 px-4 rounded shadow d-inline-flex align-items-center gap-2" href="https://forms.gle/XEeuNGXJCLmzFR6z6" 
