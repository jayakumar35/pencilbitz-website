...
<body class="bg-gray-100">
  ...
  <div  style="max-width: 1520px; background-image: none;" class="container my-10 ">
    ...
    <li class="flex items-center">
      <a href="cryptography-and-network-security-book-s24.php" class="hover:underline text-blue-600 flex items-center">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 flex flex-row items-center md:items-start">
        <div class="flex flex-col gap-2 mb-4">
          <!-- Thumbnails -->
          <img
        src="assets/img/new/book-page/cryptography-sep-1.png"
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 flex flex-col justify-between pl-0 md:pl-8 mt-6 md:mt-0">
        <div>
          <h2 id="book-name" class="text-3xl font-semibold text-red-600 mb-2"> Cryptography and Network Security</h2>
          <div class="mb-3">
        ...
        <div class="mt-3 border-t pt-2">
          ...
          btn.textContent = 'Read more...';
            ...
            <p class="text-black-400 font-medium ">MRP: <span class="text-gray-600 mb-2"> ₹400</span></p>
           
            <span class="text-base text-gray-500 line-through ml-2">₹500</span>
            <span class="text-xs text-gray-600 ml-2">(Inclusive of all taxes)</span>
            </div>
            <a href="cryptography-and-network-security-order-s24.php" class="mt-2 inline-block w-full md:w-auto text-white bg-red-600 font-bold py-2 px-6 rounded transition text-center hover:text-white hover:bg-red-800">
