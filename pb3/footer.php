<footer class="bg-dark text-light">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 footer-item pr-50 pr-xs-15">
                        <div class="f-item about">
                            ...
                            <p>
                                Welcome to PencilBitz, your trusted partner for comprehensive publication services and patent grant services.We are dedicated to supporting innovators and researchers by providing top-notch solutions to bring their ideas to the world.
                            </p>
                            <div class="opening-hours">
                                ...
                                <ul>
                                    <li> 
                                        ...
                                        <div class="working-hour">10am – 5pm</div>
                                    </li>
                                    <li>
                    ...
                    <div class="col-lg-4 col-md-6 footer-item">
                        ...
                        <ul class="footer-social">
                            <li>
                                <a href="https://www.facebook.com/pencilbitz">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.twitter.com/pencilbitz">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/pencilbitz">
                                    <i class="fab fa-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/pencilbitz">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p>&copy; Copyright <?php echo date('Y'); ?>. <a href="https://www.pencilbitz.com">pencilbitz</a></p>
                    </div>
